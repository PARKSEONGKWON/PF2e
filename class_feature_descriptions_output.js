const CLASS_FEATURE_DESCRIPTIONS = [
  ...
  {name_ko:"큰 결의", name_en:"Resolve", cat:"feature", class_id:"bard", feat_level:9, summary:"최고의 공연은 자신의 마음에 대한 이해와 완벽한 집중을 요합니다. 의지 내성 숙련도가 달인으로 증가. 의지 내성에서 성공을 굴리면 대성공."},
  {name_ko:"경각 감각", name_en:"Vigilant Senses", cat:"feature", class_id:"bard", feat_level:11, summary:"예리한 인식력과 세부 사항에 대한 주의력을 발달시켰습니다. 감지 숙련도가 달인으로 증가."},
  {name_ko:"무기 전문화", name_en:"Weapon Specialization", cat:"feature", class_id:"bard", feat_level:11, summary:"가장 잘 아는 무기로 더 큰 부상을 입힐 수 있습니다. 전문가인 무기와 비무장 공격으로 추가 피해 2. 달인이면 3, 전설이면 4."},
  ...
  {name_ko:"달인 주문시전자", name_en:"Master Spellcaster", cat:"feature", class_id:"bard", feat_level:15, summary:"하프의 줄처럼 마법의 실을 뜯습니다. 주문 공격 수정치와 주문 DC 숙련도가 달인으로 증가."},
  ...
  {name_ko:"무기 전문화", name_en:"Weapon Specialization", cat:"feature", class_id:"cleric", feat_level:13, summary:"전문가인 무기와 비무장 공격으로 추가 피해 2(달인 3, 전설 4)."},
  ...
  {name_ko:"야생 의지력", name_en:"Wild Resolve", cat:"feature", class_id:"druid", feat_level:11, summary:"의지 내성 숙련도가 달인으로. 의지 내성에서 성공 시 대성공."},
  {name_ko:"평갑 전문가", name_en:"Medium Armor Expertise", cat:"feature", class_id:"druid", feat_level:13, summary:"경갑, 평갑, 비무장 방어 숙련도가 전문가로 증가."},
  {name_ko:"무기 전문화", name_en:"Weapon Specialization", cat:"feature", class_id:"druid", feat_level:13, summary:"전문가인 무기와 비무장 공격으로 추가 피해 2(달인 3, 전설 4)."},
  {name_ko:"달인 주문시전자", name_en:"Master Spellcaster", cat:"feature", class_id:"druid", feat_level:15, summary:"주문 공격 수정치와 주문 DC 숙련도가 달인으로 증가."},
  ...
  {name_ko:"파이터 무기 달인", name_en:"Fighter Weapon Mastery", cat:"feature", class_id:"fighter", feat_level:5, summary:"특정 무기 그룹에서 비할 데 없는 기술을 가지고 있습니다. 무기 그룹 하나를 선택합니다. 해당 그룹의 단순/군용 무기와 비무장 공격에 대한 숙련도가 달인으로 증가. 해당 무기나 비무장 공격으로 치명타 시 치명 특성 효과를 적용합니다."},
  {name_ko:"전장 측량", name_en:"Battlefield Surveyor", cat:"feature", class_id:"fighter", feat_level:7, summary:"감지 숙련도가 달인으로 증가."},
  {name_ko:"무기 전문화", name_en:"Weapon Specialization", cat:"feature", class_id:"fighter", feat_level:7, summary:"전문가인 무기/비무장 공격으로 추가 피해 2(달인 3, 전설 4)."},
  ...
  {name_ko:"무기 전설", name_en:"Weapon Legend", cat:"feature", class_id:"fighter", feat_level:13, summary:"파이터 무기 달인으로 선택한 그룹의 단순/군용 무기와 비무장 공격 숙련도가 전설로 증가. 다른 단순/군용 무기와 비무장 공격은 달인으로. 고급 무기 숙련도는 전문가로."},
  {name_ko:"번뜩이는 반사", name_en:"Evasion", cat:"feature", class_id:"fighter", feat_level:15, summary:"반사 내성에서 성공 시 대성공."},
  {name_ko:"상위 무기 전문화", name_en:"Greater Weapon Specialization", cat:"feature", class_id:"fighter", feat_level:15, summary:"무기 전문화의 추가 피해가 증가합니다. 전문가 4, 달인 6, 전설 8."},
  ...
  {name_ko:"갑옷 달인", name_en:"Armor Mastery", cat:"feature", class_id:"fighter", feat_level:17, summary:"모든 갑옷과 비무장 방어 숙련도가 달인으로 증가."},
  {name_ko:"다재다능한 전설", name_en:"Versatile Legend", cat:"feature", class_id:"fighter", feat_level:19, summary:"전투의 모든 측면을 익혔습니다. 파이터 클래스 DC가 달인으로. 모든 단순/군용 무기와 비무장 공격이 전설로. 모든 고급 무기가 달인으로 증가."},
  ...
  {name_ko:"감지 달인", name_en:"Perception Master", cat:"feature", class_id:"ranger", feat_level:7, summary:"감지 숙련도가 달인으로 증가."},
  {name_ko:"무기 전문화", name_en:"Weapon Specialization", cat:"feature", class_id:"ranger", feat_level:7, summary:"전문가인 무기와 비무장 공격으로 추가 피해 2(달인 3, 전설 4)."},
  ...
  {name_ko:"관리인의 인내", name_en:"Warden", cat:"feature", class_id:"ranger", feat_level:11, summary:"인내 내성 숙련도가 달인으로 증가. 인내 내성에서 성공 시 대성공."},
  ...
  {name_ko:"군용 무기 달인", name_en:"Weapon Mastery", cat:"feature", class_id:"ranger", feat_level:13, summary:"단순 무기, 군용 무기, 비무장 공격 숙련도가 달인으로 증가."},
  {name_ko:"상위 자연 반사", name_en:"Greater Evasion", cat:"feature", class_id:"ranger", feat_level:15, summary:"반사 내성 숙련도가 달인으로 증가. 반사 내성에서 대실패 시 실패. 피해를 주는 효과에 대한 반사 내성 실패 시 절반 피해."},
  {name_ko:"상위 무기 전문화", name_en:"Greater Weapon Specialization", cat:"feature", class_id:"ranger", feat_level:15, summary:"무기 전문화의 추가 피해가 증가합니다. 전문가 4, 달인 6, 전설 8."},
  ...
  {name_ko:"평갑 달인", name_en:"Medium Armor Mastery", cat:"feature", class_id:"ranger", feat_level:19, summary:"경갑, 평갑, 비무장 방어 숙련도가 달인으로 증가."},
  ...
  {name_ko:"회피 반사", name_en:"Evasion", cat:"feature", class_id:"rogue", feat_level:7, summary:"반사 내성 숙련도가 달인으로. 반사 내성에서 성공 시 대성공."},
  {name_ko:"경각 감각", name_en:"Vigilant Senses", cat:"feature", class_id:"rogue", feat_level:7, summary:"예리한 인식력과 세부 사항에 대한 주의력을 발달시켰습니다. 감지 숙련도가 달인으로 증가."},
  {name_ko:"무기 전문화", name_en:"Weapon Specialization", cat:"feature", class_id:"rogue", feat_level:7, summary:"전문가인 무기와 비무장 공격으로 추가 피해 2(달인 3, 전설 4)."},
  ...
  {name_ko:"달인 속임수", name_en:"Master Tricks", cat:"feature", class_id:"rogue", feat_level:13, summary:"단순 무기, 군용 무기, 비무장 공격 숙련도가 달인으로 증가."},
  ...
  {name_ko:"민첩한 정신", name_en:"Slippery Mind", cat:"feature", class_id:"rogue", feat_level:17, summary:"의지 내성 숙련도가 달인으로. 의지 내성에서 성공 시 대성공."},
  {name_ko:"은밀 공격 4d6", name_en:"Sneak Attack 4d6", cat:"feature", class_id:"rogue", feat_level:17, summary:"은밀 공격 추가 정밀 피해가 4d6으로 증가합니다."},
  {name_ko:"경갑 달인", name_en:"Light Armor Mastery", cat:"feature", class_id:"rogue", feat_level:19, summary:"경갑, 비무장 방어 숙련도가 달인으로 증가."},
  {name_ko:"달인 타격", name_en:"Master Strike", cat:"feature", class_id:"rogue", feat_level:19, summary:"쇠약 타격 유발 시, 쇠약 효과 대신 대상에게 클래스 DC에 대해 인내 내성을 강제할 수 있습니다(무력화 효과). 대성공: 영향 없음. 성공: 쇠약 효과 적용. 실패: 쇠약 효과 + 둔화(slowed) 2. 대실패: 마비(paralyzed) 1라운드 후 쇠약 + 둔화 2."},
  ...
  {name_ko:"무기 전문화", name_en:"Weapon Specialization", cat:"feature", class_id:"witch", feat_level:13, summary:"전문가인 무기와 비무장 공격으로 추가 피해 2(달인 3, 전설 4)."},
  {name_ko:"달인 주문시전자", name_en:"Master Spellcaster", cat:"feature", class_id:"witch", feat_level:15, summary:"주문 공격 수정치와 주문 DC 숙련도가 달인으로 증가."},
  {name_ko:"제자의 의지", name_en:"Apprentice", cat:"feature", class_id:"witch", feat_level:17, summary:"의지 내성 숙련도가 달인으로. 의지 내성에서 성공 시 대성공."},
  ...
  {name_ko:"무기 전문화", name_en:"Weapon Specialization", cat:"feature", class_id:"wizard", feat_level:13, summary:"전문가인 무기와 비무장 공격으로 추가 피해 2(달인 3, 전설 4)."},
  {name_ko:"달인 주문시전자", name_en:"Master Spellcaster", cat:"feature", class_id:"wizard", feat_level:15, summary:"주문 공격 수정치와 주문 DC 숙련도가 달인으로 증가."},
  {name_ko:"놀라운 의지", name_en:"Resolve", cat:"feature", class_id:"wizard", feat_level:17, summary:"의지 내성 숙련도가 달인으로. 의지 내성에서 성공 시 대성공."},
