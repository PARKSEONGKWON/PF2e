const CLASS_FEATURE_DESCRIPTIONS = [
  {name_ko:"비학 주문시전", name_en:"Occult Spellcasting", cat:"feature", class_id:"bard", feat_level:1, summary:"비밀스러운 지식에서 마법을 끌어옵니다. 비학(occult) 전통의 주문시전자로, 주문 시전(Cast a Spell) 활동을 사용합니다(299페이지). 바드로서 주문을 시전할 때, 주문은 음악적 리프나 영리한 리메릭일 수 있고, 몸짓은 춤과 극적인 판토마임을 포함할 수 있으며, 악기를 연주하며 주문시전을 동반할 수 있습니다. 매일 최대 2개의 1랭크 주문을 시전할 수 있습니다. 주문을 시전하려면 알고 있어야 하며, 주문 레퍼토리 클래스 특성을 통해 배웁니다. 매일 시전할 수 있는 주문 수를 주문 슬롯이라 합니다. 일부 주문은 주문 공격을 시도하거나 적이 주문 DC에 대해 내성 굴림을 해야 합니다. 핵심 속성이 매력이므로, 주문 공격 수정치와 주문 DC는 매력 수정치를 사용합니다."},
  {name_ko:"합주 주문", name_en:"Composition Spells", cat:"feature", class_id:"bard", feat_level:1, summary:"공연에 마법을 불어넣어 합주(composition)라는 고유한 효과를 만들 수 있습니다. 합주는 공연(Performance) 기술을 사용해야 하는 경우가 많은 특수 유형의 주문입니다. 합주 주문은 집중 주문(focus spell)의 일종입니다. 집중 주문 1개를 시전하는 데 집중 포인트 1점이 필요하며, 집중 풀 1점으로 시작합니다. 일일 준비 시 집중 풀을 채우고, 10분간 공연하거나 새 합주를 작곡하거나 뮤즈에 몰입하는 재집중(Refocus) 활동으로 1점을 회복할 수 있습니다. 반격 공연(counter performance) 합주(370페이지)를 배워, 청각과 시각 효과에 대항하여 보호합니다."},
  ...
  {name_ko:"경갑 전문화", name_en:"Light Armor Expertise", cat:"feature", class_id:"bard", feat_level:13, summary:"경갑이나 비장갑 상태에서 피하는 법을 배웠습니다. 경갑과 비장갑 방어 숙련도가 전문가로 증가."},
  ...
  {name_ko:"신성 방어", name_en:"Divine Defense", cat:"feature", class_id:"cleric", feat_level:13, summary:"비장갑 방어가 전문가로 증가."},
  ...
  {name_ko:"방패 막기", name_en:"Shield Block", cat:"feature", class_id:"druid", feat_level:1, summary:"방패 막기(Shield Block) 일반 특기(262페이지)를 얻습니다."},
  ...
  {name_ko:"평갑 전문가", name_en:"Medium Armor Expertise", cat:"feature", class_id:"druid", feat_level:13, summary:"경갑, 평갑, 비장갑 방어 숙련도가 전문가로 증가."},
  ...
  {name_ko:"방패 막기", name_en:"Shield Block", cat:"feature", class_id:"fighter", feat_level:1, summary:"방패 막기(Shield Block) 일반 특기(262페이지)를 얻습니다."},
  ...
  {name_ko:"갑옷 전문가", name_en:"Armor Expertise", cat:"feature", class_id:"fighter", feat_level:11, summary:"모든 갑옷과 비장갑 방어 숙련도가 전문가로 증가."},
  ...
  {name_ko:"갑옷 달인", name_en:"Armor Mastery", cat:"feature", class_id:"fighter", feat_level:17, summary:"모든 갑옷과 비장갑 방어 숙련도가 대가로 증가."},
  ...
  {name_ko:"평갑 전문가", name_en:"Medium Armor Expertise", cat:"feature", class_id:"ranger", feat_level:11, summary:"경갑, 평갑, 비장갑 방어 숙련도가 전문가로 증가."},
  ...
  {name_ko:"평갑 달인", name_en:"Medium Armor Mastery", cat:"feature", class_id:"ranger", feat_level:19, summary:"경갑, 평갑, 비장갑 방어 숙련도가 대가로 증가."},
  ...
  {name_ko:"경갑 전문가", name_en:"Light Armor Expertise", cat:"feature", class_id:"rogue", feat_level:13, summary:"경갑이나 비장갑 상태에서 피하는 법을 배웠습니다. 경갑과 비장갑 방어 숙련도가 전문가로 증가."},
  ...
  {name_ko:"경갑 달인", name_en:"Light Armor Mastery", cat:"feature", class_id:"rogue", feat_level:19, summary:"경갑, 비장갑 방어 숙련도가 대가로 증가."},
  ...
  {name_ko:"방어 법의", name_en:"Defensive Robes", cat:"feature", class_id:"witch", feat_level:13, summary:"비장갑 방어 숙련도가 전문가로 증가."},
  ...
  {name_ko:"방어 법의", name_en:"Defensive Robes", cat:"feature", class_id:"wizard", feat_level:13, summary:"비장갑 방어 숙련도가 전문가로 증가."},
