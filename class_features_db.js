...
var CLASS_FEATURE_NAMES = {
  ...
  fighter: [
    ...
    {lv:1, name_ko:'방패 막기', name_en:'Shield Block', type:'feat', desc:'방패 막기 일반 재주를 얻습니다. 방패를 사용하여 피해를 경감하는 반응 행동입니다.'},
    {lv:3, name_ko:'용기', name_en:'Bravery', desc:'수많은 적과 전투의 혼란을 겪으며 두려움 앞에서도 강하게 서는 법을 배웠습니다. 의지 내성 숙련도가 전문가로 증가합니다. 의지 내성에서 공포 효과에 대해 성공 시 대성공으로 처리하며, 공포 상태값을 1 감소시킵니다.'},
