...
const SHIELD_DB = [
  ...
  {name_ko:'탑 방패', name_en:'Tower Shield', price:'10gp', ac_bonus:2, speed_penalty:-5, bulk:4, hardness:5, hp:20, bt:10},
];
...
const GEAR_DB = [
  {name_ko:'배낭', name_en:'Backpack', price:'1sp', bulk:'—'},
  {name_ko:'침낭', name_en:'Bedroll', price:'1cp', bulk:'L'},
  {name_ko:'등반 키트', name_en:'Climbing Kit', price:'5sp', bulk:1},
  {name_ko:'변장 키트', name_en:'Disguise Kit', price:'2gp', bulk:'L'},
  {name_ko:'부싯돌과 강철', name_en:'Flint and Steel', price:'5cp', bulk:'—'},
  {name_ko:'치료 키트', name_en:"Healer's Tools", price:'5gp', bulk:1},
  {name_ko:'성수(바이알)', name_en:'Holy Water', price:'3gp', bulk:'L'},
  {name_ko:'랜턴(황소눈)', name_en:'Lantern (Bulls-eye)', price:'1gp', bulk:1},
  {name_ko:'랜턴(덮개)', name_en:'Lantern (Hooded)', price:'7sp', bulk:1},
  {name_ko:'악기(휴대용)', name_en:'Instrument (Handheld)', price:'8sp', bulk:1},
  {name_ko:'종교 상징(나무)', name_en:'Religious Symbol (Wood)', price:'1sp', bulk:'L'},
  {name_ko:'종교 상징(은)', name_en:'Religious Symbol (Silver)', price:'2gp', bulk:'L'},
  {name_ko:'밧줄(50피트)', name_en:'Rope (50 ft)', price:'1sp', bulk:1},
  {name_ko:'식량(2주)', name_en:'Rations (2 weeks)', price:'8sp', bulk:'L'},
  {name_ko:'도둑 키트', name_en:"Thieves' Tools", price:'3gp', bulk:'L'},
  {name_ko:'횃불', name_en:'Torch', price:'1cp', bulk:'L'},
  {name_ko:'물통', name_en:'Waterskin', price:'5cp', bulk:'L'},
  {name_ko:'모험가 팩', name_en:"Adventurer's Pack", price:'7sp', bulk:1},
  {name_ko:'연금술사 도구', name_en:"Alchemist's Tools", price:'3gp', bulk:1},
  {name_ko:'비전 주머니', name_en:'Arcane Spellcasting Pouch', price:'1gp', bulk:'L'},
  {name_ko:'근원 상징', name_en:'Primal Focus', price:'1gp', bulk:'L'},
  {name_ko:'주문서(공백)', name_en:'Spellbook (Blank)', price:'1gp', bulk:'L'},
  {name_ko:'수리 키트', name_en:'Repair Kit', price:'2gp', bulk:1},
  {name_ko:'포션(치유, 약)', name_en:'Healing Potion (Minor)', price:'4gp', bulk:'L'},
