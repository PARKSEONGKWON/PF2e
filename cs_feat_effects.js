...
const FEAT_EFFECTS = {
  ...
  'Combat Climber': {
    effects: [{type:'display_note', text:'등반 중 발묶임 상태 면제. 한 손으로 벽을 잡고 전투 가능'}]
  },
  'Train Animal': {
  ...
  'Steady Balance': {
    effects: [{type:'display_note', text:'균형 잡기 판정 성공→대성공. 발묶임 상태 아님. 험지에서 보폭 가능'}]
  },
  'Nimble Crawl': {
  ...
  'Emotional Push': {
    effects: [{type:'display_note', text:'[반응] 적이 감정 주문 내성 실패 시, 대상이 다음 공격에 발묶임(off-guard)'}]
  },
  'Esoteric Polymath': {
  ...
  'Blind-Fight': {
    effects: [{type:'display_note', text:'은폐 단순 판정 불필요. 숨겨진 적에게 발묶임 아님. 인접 미탐지→숨겨진'}]
  },
  'Deadly Aim': {
  ...
  'Distracting Shot': {
    effects: [{type:'display_note', text:'사냥감에 원거리 치명타 또는 동일 턴 2회 명중 시 다음 턴까지 발묶임'}]
  },
  'Double Prey': {
  ...
  'Greater Distracting Shot': {
    effects: [{type:'display_note', text:'원거리 명중만으로 발묶임 부여. 치명타/2회 명중 시 다음 턴 종료까지'}]
  },
  ...
  'Snagging Strike': {
    effects: [{type:'display_note', text:'[1행동] 한 손 무기+빈 손. 근접 타격 명중 시 대상이 다음 턴까지 발묶임'}]
  },
  'Sudden Charge': {
  ...
  // ── 2레벨 ──
  'Aggressive Block': {
    effects: [{type:'display_note', text:'방패 막기 시 공격자를 5피트 밀거나 발묶임하게 할 수 있음 (선택)'}]
  },
  'Assisting Shot': {
    effects: [{type:'display_note', text:'[1행동] 원거리 타격. 명중 시 대상이 다음 공격에 발묶임'}]
  },
  'Blade Break': {
    effects: [{type:'display_note', text:'[반응] 적의 치명타 시 무기/방패를 파괴하여 경도×2만큼 피해 감소'}]
  },
  'Brutish Shove': {
    effects: [{type:'display_note', text:'[1행동] 양손 근접 타격. 명중 시 자동 5피트 밀기+발묶임'}]
  },
  'Combat Grab': {
  ...
  'Sleek Reposition': {
    effects: [{type:'display_note', text:'[1행동] 기교/장창으로 타격. 명중 시 자동 재배치. 실패 시에도 발묶임'}]
  },
  ...
  'Parting Shot': {
    effects: [{type:'display_note', text:'[2행동] 한 걸음 후 원거리 타격. 대상은 이 공격에 발묶임'}]
  },
  'Powerful Shove': {
  ...
  'Shatter Defenses': {
    effects: [{type:'display_note', text:'[1행동] 겁먹은 적에 타격. 명중+피해 시 공포가 끝날 때까지 발묶임'}]
  },
  'Shield Warden': {
  ...
  'Disorienting Opening': {
    effects: [{type:'display_note', text:'반격 타격 명중 시 대상이 다음 턴까지 발묶임'}]
  },
  'Dueling Riposte': {
  ...
  'Disarming Twist': {
    effects: [{type:'display_note', text:'[1행동] 한 손 무기+빈 손. 타격+무장 해제. 실패 시에도 발묶임'}]
  },
  'Disruptive Stance': {
  ...
  'Flinging Charge': {
    effects: [{type:'display_note', text:'[2행동] 보폭 2회(중간에 투척 타격). 명중 시 다음 근접 공격에 발묶임'}]
  },
  'Mirror Shield': {
    effects: [{type:'display_note', text:'[반응] 주문 공격 대실패 시 시전자에게 주문 반사'}]
  },
  'Overpowering Charge': {
    effects: [{type:'display_note', text:'돌진 충격으로 통과 시 근력 수정치 둔기 피해 (대성공 시 2배+발묶임)'}]
  },
  'Tactical Reflexes': {
  ...
  'Overwhelming Blow': {
    effects: [{type:'display_note', text:'[2행동] 근접 타격(다중 공격 3회). 명중 시 자동 치명타. 기절 1+발묶임'}]
  },
  'Twinned Defense': {
  ...
  'Overextending Feint': {
    effects: [{type:'display_note', text:'속임 성공 시 대상이 모든 공격에 발묶임. 대실패 시 당신이 발묶임'}]
  },
  'Plant Evidence': {
  ...
  'Tumble Behind': {
    effects: [{type:'display_note', text:'덤블 통과 성공 시 통과한 적이 다음 턴까지 발묶임'}]
  },
  'Twin Feint': {
    effects: [{type:'display_note', text:'[2행동] 각 손에 근접 무기. 같은 대상에 타격 2회. 두 번째 공격에 자동 발묶임'}]
  },
  "You're Next": {
  ...
  'Distracting Feint': {
    effects: [{type:'display_note', text:'속임으로 발묶임한 대상의 지각과 반사 내성에 -2 상황 페널티'}]
  },
  'Mobility': {
  ...
  'Unbalancing Blow': {
    effects: [{type:'display_note', text:'치명타 피해 시 대상이 다음 턴까지 당신의 공격에 발묶임'}]
  },
  'Underhanded Assault': {
  ...
  // ── 4레벨 ──
  'Dread Striker': {
    effects: [{type:'display_note', text:'겁먹은(frightened) 생물은 당신의 공격에도 발묶임'}]
  },
  'Head Stomp': {
    effects: [{type:'display_note', text:'[1행동] 엎드린 대상에 비무장 타격. 명중 시 현기증 1(치명타 2)+발묶임'}]
  },
  'Mug': {
  ...
  "Scoundrel's Surprise": {
    effects: [{type:'display_note', text:'[1행동] 변장 벗어 놀라게 함. 간파 못한 생물은 다음 공격에 발묶임'}]
  },
  'The Harder They Fall': {
    effects: [{type:'display_note', text:'발묶임한 적 넘어뜨리기 성공 시 1d6 둔기 피해. 대성공이면 +은밀 공격 피해'}]
  },
  'Twin Distraction': {
  ...
  'Sly Disarm': {
    effects: [{type:'display_note', text:'운동 대신 도둑질로 무장 해제 가능. 성공 시 대상이 발묶임'}]
  },
  'Twist the Knife': {
    effects: [{type:'display_note', text:'[1행동] 은밀 공격 피해를 준 발묶임 대상에 은밀 공격 주사위 수만큼 지속 출혈'}]
  },
  'Watch Your Back': {
  ...
  'Sly Striker': {
    effects: [{type:'display_note', text:'발묶임하지 않은 생물에도 1d6 정밀 피해 (14레벨에 2d6)'}]
  },
  'Swipe Souvenir': {
  ...
  'Precise Debilitations': {
    effects: [{type:'display_note', text:'추가 쇠약: 추가 2d6 정밀 피해 또는 대상이 발묶임'}]
  },
  'Sneak Adept': {
  ...
  'Felling Shot': {
    effects: [{type:'display_note', text:'[2행동] 발묶임한 생물에 원거리 타격. 명중 시 반사 내성 → 최대 120피트 추락'}]
  },
  'Preparation': {
  ...
  'Instant Opening': {
    effects: [{type:'display_note', text:'[1행동] 30피트 내 대상 1명이 다음 턴 종료까지 발묶임'}]
  },
  'Leave an Opening': {
    effects: [{type:'display_note', text:'발묶임한 적에 치명 타격 시 아군의 반격 타격을 유발'}]
  },
  "Stay Down!": {
  ...
  'Dispelling Slice': {
    effects: [{type:'display_note', text:'[2행동] 발묶임한 대상에 타격. 은밀 공격 피해 시 활성 주문 상쇄 시도'}]
  },
  'Perfect Distraction': {
  ...
  'Impossible Striker': {
    effects: [{type:'display_note', text:'발묶임하지 않은 대상에게도 전체 은밀 공격 피해'}]
  },
  ...
  'Surprise Attack': {
    effects: [{type:'display_note', text:'전투 시작 시 기만/은신으로 우선권 굴림 가능. 적이 아직 행동 안 했으면 발묶임'}]
  },
  'Hunt Prey': {
  ...
  // ── 로그 멀티클래스 ──
  'Rogue Dedication': {
    effects: [{type:'skill_trained', skill:'stealth'}, {type:'skill_trained', skill:'thievery'}, {type:'grant_action', summary:'기습 공격 (Surprise Attack) — 전투 시작 시 선제를 굴리기 전에 행동한 적이 아닌 모든 생물은 당신에게 발묶임(flat-footed)입니다. 첫 턴이 끝나면 해제.'}, {type:'display_note', text:'기술 재주 1개 습득. 경갑 숙련됨. 로그 클래스 DC 숙련'}]
  },
  'Basic Trickery': {
  ...
  'Uncanny Dodge': {
    effects: [{type:'display_note', text:'이점 부정(Deny Advantage) 획득. 은폐/기습의 발묶임 면역'}]
  },
  'Evasiveness': {
