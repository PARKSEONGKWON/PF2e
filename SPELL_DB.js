...
const SPELL_DB = [
  ...
  { name_ko: "오라 읽기", name_en: "Read Aura", rank: 1, is_cantrip: true, is_focus: false,
    traditions: [], actions: "", traits: [],
    summary: "",
    desc: "" },
  { name_ko: "경보", name_en: "Alarm", rank: 1, is_cantrip: false, is_focus: false,
    traditions: [], actions: "", traits: [],
    summary: "경보 영역에 지정 크기(소형 이상)의 생물이 들어오면 알림. 정신적(마음속 삐 소리, 주의를 깨움) 또는 청각적(모두 들을 수 있는 종소리) 경보를 선택합니다. 시전 시 경보를 무",
    desc: "경보 영역에 지정 크기(소형 이상)의 생물이 들어오면 알림. 정신적(마음속 삐 소리, 주의를 깨움) 또는 청각적(모두 들을 수 있는 종소리) 경보를 선택합니다. 시전 시 경보를 무시하는 생물을 지정할 수 있습니다.<br>" },
  { name_ko: "점술", name_en: "Augury", rank: 2, is_cantrip: false, is_focus: false,
    traditions: [], actions: "", traits: [],
    summary: "약 30분 이내의 특정 행동의 결과에 대해 질문합니다. GM이 \"길조,\" \"흉조,\" \"길조와 흉조\" 또는 \"불명확\" 중 하나로 대답합니다. 같은 주제에 하루 여러 번 시전 시 이후",
    desc: "약 30분 이내의 특정 행동의 결과에 대해 질문합니다. GM이 \"길조,\" \"흉조,\" \"길조와 흉조\" 또는 \"불명확\" 중 하나로 대답합니다. 같은 주제에 하루 여러 번 시전 시 이후 결과가 무작위가 됩니다." },
  { name_ko: "우발 대비", name_en: "Contingency", rank: 7, is_cantrip: false, is_focus: false,
    traditions: [], actions: "", traits: [],
    summary: "우발적 발동 조건이 걸린 주문을 짜넣어, 필요할 때 자동으로 발동되게 합니다. 이 주문을 시전할 때, 4랭크 이하의 주문도 함께 시전합니다. 그 주문은 시전에 3행동 이하가 필요해",
    desc: "우발적 발동 조건이 걸린 주문을 짜넣어, 필요할 때 자동으로 발동되게 합니다. 이 주문을 시전할 때, 4랭크 이하의 주문도 함께 시전합니다. 그 주문은 시전에 3행동 이하가 필요해야 하며, 비용이나 집중점 조건이 없어야 합니다. 이것이 당신의 우발 주문이 됩니다. 우발 주문은 당신이 발동시킬 때까지 대기 상태를 유지합니다. 우발 대비 시전 시 어떤 사건, 행동, 또는 상황이 우발 주문을 발동시킬지 선택합니다. 가능한 발동 조건을 여러 개 지정하더라도, 한 번에 하나만 적용될 수 있습니다. 발동 조건이 충족되면 우발 주문이 자동으로 시전되며, 이 때 당신이 의식이 없는 상태여도 무방합니다. 일반적으로 시전할 때와 동일한 대상, 사거리, 기타 매개변수를 사용하되, 대상을 선택해야 하는 주문이고 당신이 유효한 대상이라면 자동으로 당신을 대상으로 삼습니다.<br><br>한 번에 하나의 우발 대비 주문만 준비할 수 있습니다. 우발 대비를 다시 시전하면 이전 우발 주문은 사라집니다.<br>" },
  { name_ko: "음식 생성", name_en: "Create Food", rank: 2, is_cantrip: false, is_focus: false,
    traditions: [], actions: "", traits: [],
    summary: "",
    desc: "" },
  { name_ko: "마법 위장", name_en: "Disguise Magic", rank: 1, is_cantrip: false, is_focus: false,
    traditions: [], actions: "", traits: [],
    summary: "아이템이나 주문의 마법 오라가 마법 탐지 등에 어떻게 보이는지 변경합니다. 오라를 완전히 숨기거나, 낮은 레벨의 일반 아이템으로 등록시키거나, 같거나 낮은 랭크의 일반 주문으로 보",
    desc: "아이템이나 주문의 마법 오라가 마법 탐지 등에 어떻게 보이는지 변경합니다. 오라를 완전히 숨기거나, 낮은 레벨의 일반 아이템으로 등록시키거나, 같거나 낮은 랭크의 일반 주문으로 보이게 할 수 있습니다. 해제 가능. 더 높은 랭크의 마법 탐지/오라 읽기는 환영을 불신할 수 있습니다.<br>" },
  { name_ko: "청각 투시", name_en: "Clairaudience", rank: 3, is_cantrip: false, is_focus: false,
    traditions: [], actions: "", traits: [],
    summary: "특질: 집중, 조작, 투시 | 전통: 비전, 비학시전: 1분 | 사거리: 500피트 | 지속 시간: 10분사거리 내 위치에 보이지 않는 떠다니는 귀를 만듭니다(효과선 밖도 가능).",
    desc: "<strong>특성:</strong> 집중, 조작, 투시 | <strong>전통:</strong> 비전, 비학<br><strong>시전:</strong> 1분 | <strong>사거리:</strong> 500피트 | <strong>지속 시간:</strong> 10분<br>사거리 내 위치에 보이지 않는 떠다니는 귀를 만듭니다(효과선 밖도 가능). 움직일 수 없지만 정상적인 청각 감각으로 귀를 통해 들을 수 있습니다.</div>" },
  { name_ko: "투시", name_en: "Clairvoyance", rank: 4, is_cantrip: false, is_focus: false,
    traditions: [], actions: "", traits: [],
