...
const SPELL_DB = [
  ...
  { name_ko: "음식 정화", name_en: "Cleanse Cuisine", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "영역 내 모든 음식과 음료를 맛있는 음식으로 변환합니다. 물을 와인이나 다른 고급 음료로, 음식의 맛과 재료를 미식가 수준으로 향상. 독소와 오염물질 제거 가능. 이후 오염, 자연 부패, 영양 향상은 불가.<br><strong>강화(+2):</strong> 영역에 인접한 1 세제곱피트 추가." },
  ...
  { name_ko: "현란한 색채", name_en: "Dizzying Colors", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "소용돌이치는 색채가 생물을 눈멀게, 눈부시게, 또는 멍하게 합니다.<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> 1라운드 눈부심(dazzled). <strong>실패:</strong> 1라운드 눈멈+1분 눈부심. <strong>대실패:</strong> 1라운드 멍해짐(stunned) 1+1분 눈멈+10분 눈부심." },
  ...
  { name_ko: "쇠약", name_en: "Enfeeble", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "대상의 근력을 빼앗습니다.<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> <strong>약화(enfeebled) 1</strong>. <strong>실패:</strong> <strong>약화 2</strong>. <strong>대실패:</strong> <strong>약화 3</strong>." },
  ...
  { name_ko: "힘의 포격", name_en: "Force Barrage", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "오류 없는 마법 힘의 파편으로 생물을 강타합니다. 1행동 시 <strong>1발(1d4+1 힘 피해)</strong>, 2행동 시 <strong>2발</strong>, 3행동 시 <strong>3발</strong>. 각 탄을 같은 대상이나 다른 대상에 배분할 수 있습니다. <strong>명중 굴림 없이 자동 명중.</strong><br><strong>강화(+2):</strong> 탄 1발 추가." },
  ...
  { name_ko: "암울한 촉수", name_en: "Grim Tendrils", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "직선의 생물에 <strong>2d4 공허 피해</strong> + 기본 인내. 실패 시 <strong>1 지속 출혈 피해</strong>.<br><strong>강화(+1):</strong> 피해 +2d4, 지속 출혈 +1." },
  ...
  { name_ko: "해로움", name_en: "Harm", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "공허 에너지가 산 것을 해치거나 언데드를 치유합니다. 1행동: 접촉 대상 1, <strong>1d8 피해</strong>(산 것에) 또는 회복(언데드에). 2행동: 30피트 사거리 대상 1, 같은 효과. 3행동: 30피트 발산 영역 모든 생물에 영향. 산 것에 피해 시 기본 인내. 언데드 치유 시 내성 없음.<br><strong>강화(+1):</strong> 피해/회복 +1d8." },
  ...
  { name_ko: "치유", name_en: "Heal", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "활력 에너지가 산 것을 치유하거나 언데드를 해칩니다. 1행동: 접촉 대상 1, <strong>1d8 HP 회복</strong>(산 것에) 또는 피해(언데드에). 2행동: 30피트 사거리 대상 1, 같은 효과. 3행동: 30피트 발산 영역 모든 생물에 영향. 산 것에 회복 시 내성 없음. 언데드에 피해 시 기본 인내.<br><strong>강화(+1):</strong> 피해/회복 +1d8. 3행동 시전 시 +1d8 대신 +1d10." },
  ...
  { name_ko: "수류 밀기", name_en: "Hydraulic Push", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "물의 폭발로 생물에 피해를 주고 밀어냅니다. <strong>3d6 둔기 피해</strong>(인내). 실패 시 5피트 밀려남. 대실패 시 10피트 밀려남+넘어뜨려짐.<br><strong>강화(+1):</strong> 피해 +2d6." },
  ...
  { name_ko: "흉조", name_en: "Ill Omen", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "불운의 저주를 내립니다. 의지 실패 시 대상의 다음 판정에서 <strong>d20을 두 번 굴려 낮은 것을 사용</strong>(불운 효과)." },
  ...
  { name_ko: "활력 주입", name_en: "Infuse Vitality", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "공격에 활력 에너지를 불어넣어 언데드에 추가 피해를 줍니다. 대상의 타격이 언데드에 <strong>추가 1d6 활력 피해</strong>를 줍니다.<br><strong>강화(+2):</strong> 추가 피해 +1d6." },
  ...
  { name_ko: "정신 연결", name_en: "Mindlink", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "10분 분량의 정보를 즉시 정신적으로 전달합니다. 한 방향 전송이며, 대상이 당신에게 답하려면 자기 차례에 다시 이 주문을 시전해야 합니다." },
  ...
  { name_ko: "반려 은닉", name_en: "Pet Cache", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "사역마나 동물 동료를 주머니 차원에 숨깁니다. 해제하거나 지속 시간이 끝나면 즉시 나타납니다." },
  ...
  { name_ko: "환영 하수인", name_en: "Phantasmal Minion", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "인간형의 윤곽을 가진 환영 하수인을 소환합니다. 하수인을 투명하게 만들거나 덧없는 모습으로 만들 수 있지만, 명백히 마법적 효과이며 실제 생물이 아닙니다. 하수인은 일반 하수인 규칙을 따릅니다." },
  ...
  { name_ko: "환영 고통", name_en: "Phantom Pain", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "지속적인 고통으로 구역질을 유발합니다. <strong>2d4 정신 피해</strong>+<strong>1d4 지속 정신 피해</strong>(의지). 지속 피해 받는 동안 <strong>구역질(sickened) 1</strong>.<br><strong>강화(+1):</strong> 초기 +2d4, 지속 +1d4." },

  { name_ko: "보호", name_en: "Protection", rank: 1, is_cantrip: false, is_focus: false,
    traditions: ["divine", "occult"], actions: "2행동", traits: ["조작"],
    summary: "생물의 AC를 올립니다. 대상의 AC에 +1 상태 보너스.",
    desc: "생물의 AC를 올립니다. 대상의 AC에 <strong>+1 상태 보너스</strong>." },
  ...
  { name_ko: "파쇄 잔해", name_en: "Pummeling Rubble", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "돌 원뿔을 발사하여 생물을 때립니다. <strong>2d4 둔기 피해</strong>(반사). 실패 시 <strong>험지(1라운드)</strong>가 됨.<br><strong>강화(+1):</strong> 피해 +2d4." },
  ...
  { name_ko: "위로", name_en: "Soothe", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "대상을 치유하고 정신 공격에 대해 강화합니다. <strong>1d10+4 HP 회복</strong>. 대상이 다음 정신 효과에 대한 내성에 <strong>+2 상태 보너스</strong>(1라운드).<br><strong>강화(+1):</strong> 회복 +1d10+4." },
  ...
  { name_ko: "거미 독", name_en: "Spider Sting", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "생물에 피해를 주고 거미 독을 감염시킵니다. <strong>1d4 독 피해</strong>+거미 독 고통(최대 단계 4: 1d4 독 피해+약화 1)." },
  ...
  { name_ko: "영혼 연결", name_en: "Spirit Link", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "자신의 HP를 지속적으로 다른 이에게 전달합니다. 대상이 피해를 받을 때마다, 피해의 절반을 당신이 대신 받습니다(영혼 연결을 통해)." },
  ...
  { name_ko: "확실한 타격", name_en: "Sure Strike", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "다음 공격이 특히 정확합니다. 이 턴의 다음 명중 굴림에서 <strong>d20을 두 번 굴려 높은 것을 사용</strong>(행운 효과)." },
  ...
  { name_ko: "뇌격", name_en: "Thunderstrike", rank: 1, is_cantrip: false, is_focus: false,
    ...
    desc: "벼락을 내려칩니다. 대상에 <strong>1d12 전기 피해 + 1d4 음파 피해</strong>(기본 반사).<br><strong>강화(+1):</strong> 전기 +1d12, 음파 +1d4." },
  ...
  { name_ko: "산성 집게", name_en: "Acid Grip", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "산성 손이 적을 잡고 해칩니다. 대상에 <strong>3d6 산성 피해</strong>를 가하고 인내 내성을 요구합니다. 유지 시마다 추가 피해를 가합니다.<br><strong>성공:</strong> 절반 피해, 주문 종료. <strong>실패:</strong> 전체 피해, 조이기(grabbed). <strong>대실패:</strong> 2배 피해, 조이기, 억제(restrained).<br><strong>강화(+2):</strong> 피해 +3d6." },
  ...
  { name_ko: "동물의 메신저", name_en: "Animal Messenger", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "작은 동물에게 메시지를 맡겨 지정 위치의 지정 대상에게 전달하게 합니다. 동물이 일반 속도로 이동하여 대상에게 도달하면 메시지를 전달합니다." },
  ...
  { name_ko: "물체 활성화", name_en: "Animate Object", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "물체에 생명을 불어넣어 이동하게 합니다. 물체가 소형 또는 중형의 <strong>활성화된 물체</strong>가 되어 하수인으로 행동합니다. 부피에 따라 HP, 공격 수정치, 피해가 결정됩니다." },
  ...
  { name_ko: "타오르는 화살", name_en: "Blazing Bolt", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "열과 불꽃의 광선. 주문 명중 굴림. 명중 시 <strong>2d6 화염 피해</strong>, 치명 시 2배. 추가 행동으로 추가 대상(최대 3). 2행동 이상 시 피해 4d6. 다중공격 페널티는 모든 굴림 후 적용.<br><strong>강화(+1):</strong> 각 광선 피해 +1d6." },
  ...
  { name_ko: "귀머거리", name_en: "Deafness", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "대상의 청각을 빼앗습니다. 인내 내성 시도 후 1분 면역.<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> 1라운드 귀먹음. <strong>실패:</strong> 10분 귀먹음. <strong>대실패:</strong> 영구 귀먹음." },
  ...
  { name_ko: "삽입 메시지", name_en: "Embed Message", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "물체에 환영 메시지를 남겨 나중에 발동되게 합니다. 시전 시 메시지(최대 25단어)와 발동 조건을 설정합니다. 조건이 충족되면 당신의 환영 이미지가 나타나 메시지를 전합니다.<br><strong>강화(+2):</strong> 메시지를 25단어 더 추가 가능." },
  ...
  { name_ko: "거짓 활력", name_en: "False Vitality", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "<strong>10 임시 HP</strong>를 얻습니다. 다른 출처의 임시 HP와 누적되지 않습니다.<br><strong>강화(+1):</strong> 임시 HP +5." },
  ...
  { name_ko: "떠다니는 불꽃", name_en: "Floating Flame", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "소환된 불이 당신의 명령에 따라 이동합니다. 5피트 정육면체 크기의 불을 소환하여 유지 시마다 최대 60피트 이동. 불이 생물의 칸을 통과하면 <strong>2d4 화염 피해</strong>(기본 반사). 한 턴에 같은 생물에 한 번만.<br><strong>강화(+1):</strong> 피해 +1d4." },
  ...
  { name_ko: "유령 운반자", name_en: "Ghostly Carrier", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "반물질적 형상을 만들어 접촉 주문을 대신 전달합니다. 형상은 이동 속도 30피트. 유지 시 형상을 이동시키고, 접촉 사거리 주문을 형상의 위치에서 전달 가능." },
  ...
  { name_ko: "웃음 발작", name_en: "Laughing Fit", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "웃음이 생물의 행동을 방해합니다. 의지 실패 시 <strong>서투름(clumsy) 2</strong>+집중 주문에 DC 5 단순 판정 필요. 대실패 시 추가로 <strong>엎드려짐(prone)</strong>." },
  ...
  { name_ko: "소음 폭발", name_en: "Noise Blast", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "강력한 소음으로 생물에 피해를 주고 귀먹게 합니다. <strong>4d6 음파 피해</strong>(기본 인내). 실패 시 1라운드 귀먹음. 대실패 시 1분 귀먹음.<br><strong>강화(+1):</strong> 피해 +2d6." },
  ...
  { name_ko: "참나무 강인", name_en: "Oaken Resilience", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "나무의 회복력을 부여하지만 가연성도 함께. 대상의 최대 HP에 <strong>+임시 HP 10</strong>을 얻고, 밀기/넘어뜨리기에 대한 인내 DC에 +2. 그러나 <strong>화염 약점 2</strong>.<br><strong>강화(+2):</strong> 임시 HP +5, 화염 약점 +1." },
  ...
  { name_ko: "드러내는 빛", name_en: "Revealing Light", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "마법의 빛이 영역을 휩쓸어 숨겨진 것을 드러냅니다. 빛의 외양(다채로운 불꽃, 반짝이는 빛 등)을 선택할 수 있습니다. 영향받는 생물은 <strong>현혹됨(dazzled)</strong> 상태가 됩니다. 투명한 생물이었다면 <strong>은폐됨(concealed)</strong> 상태로 변합니다. 다른 이유로 이미 은폐된 생물은 은폐 상태가 해제됩니다.<br><strong>결정적 성공:</strong> 영향 없음. <strong>성공:</strong> 2라운드. <strong>실패:</strong> 1분. <strong>결정적 실패:</strong> 10분." },
  ...
  { name_ko: "나무 형성", name_en: "Shape Wood", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "나무를 원하는 형태로 변환합니다. 크기는 가공 전과 같아야 합니다. 단순한 형태만 가능(복잡한 움직이는 부품 불가)." },
  ...
  { name_ko: "분쇄", name_en: "Shatter", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "고주파 음파로 물체를 파괴합니다. <strong>2d10 음파 피해</strong>(물체의 경도 무시). 착용/보유 물체면 소유자가 기본 인내 내성.<br><strong>강화(+1):</strong> 피해 +1d10." },
  ...
  { name_ko: "영적 무장", name_en: "Spiritual Armament", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "현재 착용하거나 들고 있는 무기 하나의 유령 같은 마법 복제본을 만들어 대상에게 날립니다. 대상의 AC에 주문 명중 굴림을 굴려 명중 시 <strong>2d8 피해</strong>(급소 공격 시 2배 피해). 피해 유형은 선택한 무기와 동일하며, 영혼 피해가 더 해롭다면 영혼 피해로 대체됩니다. 이 공격은 다중 공격 페널티에 기여합니다. 공격 후 무기는 당신 곁으로 돌아옵니다. 주문을 성별화하면 공격도 성별화됩니다. 유지 시마다 120피트 내 원하는 생물에 다시 공격할 수 있습니다.<br><strong>강화(+2):</strong> 피해 +1d8." },
  ...
  { name_ko: "상태", name_en: "Status", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "동의하는 생물의 위치와 안녕을 추적합니다. 대상의 방향, 대략적 거리, 현재 HP의 대략적 상태(건강/부상/빈사/사망)를 알 수 있습니다.<br><strong>강화(+1):</strong> 추가 1 대상." },
  ...
  { name_ko: "멍청하게", name_en: "Stupefy", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "대상의 정신을 둔하게 하여 주문시전을 불안정하게 만듭니다. 의지 실패 시 <strong>멍청함(stupefied) 2</strong>. 대실패 시 멍청함 4." },
  ...
  { name_ko: "염동 기동", name_en: "Telekinetic Maneuver", rank: 2, is_cantrip: false, is_focus: false,
    ...
    desc: "생물을 염동력으로 무장 해제(Disarm), 재배치(Reposition), 밀기(Shove), 넘어뜨리기(Trip)합니다. 주문 공격 대신 적절한 기동 판정을 합니다." },
  ...
  { name_ko: "아늑한 오두막", name_en: "Cozy Cabin", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "악천후로부터 보호된 임시 오두막을 소환합니다. 20피트 정육면체, 최대 10명 수용. 내부는 따뜻하고 건조하며, 비와 바람을 차단합니다. 오두막은 피해를 받지 않지만 마법 해제로 제거 가능." },
  ...
  { name_ko: "신앙 위기", name_en: "Crisis of Faith", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "대상의 신앙을 공격하여 의심과 정신적 혼란을 일으킵니다. <strong>6d6 정신 피해</strong>(신성 주문시전자에게는 6d8).<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> 절반 피해. <strong>실패:</strong> 전체 피해; 신성 시전자면 멍청함 1(1라운드). <strong>대실패:</strong> 2배 피해, 멍청함 1(1라운드), 신성 주문 시전 불가(1라운드).<br>자신의 신격 추종자에게 중대한 이유 없이 시전하면 대부분의 신에게 금기(anathema).<br><strong>강화(+1):</strong> 피해 +2d6(또는 신성 시전자에게 +2d8)." },
  ...
  { name_ko: "추적의 잔상", name_en: "Ephemeral Tracking", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "생물의 비물질적 흔적(영혼의 잔재, 정신적 인상)을 추적합니다. 에테르 차원이나 그림자 차원을 통해 이동한 생물도 추적 가능." },
  ...
  { name_ko: "화염구", name_en: "Fireball", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "불의 폭발이 영역 내 생물을 태웁니다. <strong>6d6 화염 피해</strong>(기본 반사).<br><strong>강화(+1):</strong> 피해 +2d6." },
  ...
  { name_ko: "번개줄기", name_en: "Lightning Bolt", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "번개가 직선의 모든 생물을 타격합니다. <strong>4d12 전기 피해</strong>(기본 반사).<br><strong>강화(+1):</strong> 피해 +1d12." },
  ...
  { name_ko: "미친 원숭이들", name_en: "Mad Monkeys", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "미친 원숭이 떼를 소환합니다. 유지 시 원숭이를 20피트 이동시킬 수 있습니다. 원숭이가 있는 칸의 적은 <strong>2d8 둔기 피해</strong>(기본 반사). 원숭이가 물건을 훔치거나 방해할 수도 있습니다." },
  ...
  { name_ko: "악의의 그림자", name_en: "Malicious Shadow", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "대상의 그림자가 적대적으로 변합니다. 의지 실패 시 대상의 그림자가 매 턴 <strong>2d6 공허 피해</strong>를 줍니다. 대상이 밝은 빛에서는 피해 2배, 어둠에서는 피해 없음." },
  ...
  { name_ko: "돌과 하나", name_en: "One with Stone", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "돌 속으로 녹아들거나 돌로 변합니다. 돌의 표면에 녹아들면 내부에서 안전하게 숨을 수 있습니다. 돌의 감각으로 외부를 인지할 수 있지만 행동은 불가." },
  ...
  { name_ko: "개인 눈보라", name_en: "Personal Blizzard", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "대상 주위에 작은 눈보라가 소용돌이칩니다. <strong>1d6 냉기 피해</strong>(반사)+대상이 <strong>은폐(concealed)</strong>(다른 이에 대해). 유지 시 재피해.<br><strong>강화(+1):</strong> 피해 +1d6." },
  ...
  { name_ko: "진실의 종", name_en: "Ring of Truth", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "진실이 말해지면 종이 울립니다. 대상이 의도적으로 거짓말을 하면 감지 가능(진실을 말하면 종이 울림). 의지 실패 시 거짓말을 하기 어려워짐(기만 판정에 -4)." },
  ...
  { name_ko: "룬 함정", name_en: "Rune Trap", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "표면에 마법 룬 함정을 설치합니다. 생물이 밟으면 발동하여 <strong>4d8 피해</strong>(기본 반사, 산성/냉기/전기/화염 중 선택).<br><strong>강화(+1):</strong> 피해 +2d8." },
  ...
  { name_ko: "흡혈 잔치", name_en: "Vampiric Feast", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "접촉으로 공허 피해를 주고 임시 HP를 얻습니다. <strong>5d6 공허 피해</strong>(기본 인내). 대상이 받은 피해만큼 <strong>임시 HP</strong>(1분 지속, 대상 HP의 절반까지).<br><strong>강화(+1):</strong> 피해 +2d6." },
  ...
  { name_ko: "사생활 장막", name_en: "Veil of Privacy", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "마법적 탐지로부터 생물이나 물체를 보호합니다. 마법 탐지, 투시 등이 대상을 감지할 수 없습니다." },
  ...
  { name_ko: "가시 벽", name_en: "Wall of Thorns", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "가시 덤불의 벽을 키워 통과하는 생물에 피해를 줍니다. 60피트 길이, 10피트 높이, 5피트 두께. 통과 시 <strong>3d4 관통 피해</strong>(매 5피트마다). 5피트 이동에 5피트 추가 비용.<br><strong>강화(+1):</strong> 피해 +1d4." },
  ...
  { name_ko: "바람 벽", name_en: "Wall of Wind", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "돌풍의 벽을 만들어 이동과 원거리 공격을 방해합니다. 120피트 길이, 20피트 높이. 벽을 통과하는 원거리 공격은 무시(거대 투사체 제외). 벽을 통과하려면 인내 내성(주문 DC). 안개, 가스 등을 분산." },
  ...
  { name_ko: "열렬한 확신", name_en: "Zealous Conviction", rank: 3, is_cantrip: false, is_focus: false,
    ...
    desc: "불굴의 확신과 열정을 동의하는 생물에 불어넣습니다. 대상이 <strong>10 임시 HP</strong>를 얻고, 공포(frightened) 및 도주(fleeing)에 대한 내성에 <strong>+2 상태 보너스</strong>.<br><strong>강화(+1):</strong> 임시 HP +3." },
  ...
  { name_ko: "화염 방패", name_en: "Fire Shield", rank: 4, is_cantrip: false, is_focus: false,
    ...
    desc: "불꽃이 당신을 보호합니다. <strong>냉기 저항 5</strong>를 얻습니다. 인접 생물이 근접 공격으로 당신에게 피해를 주면 <strong>2d6 화염 피해</strong>를 받습니다.<br><strong>강화(+2):</strong> 냉기 저항 +5, 반사 화염 피해 +1d6." },
  ...
  { name_ko: "달콤한 말", name_en: "Honeyed Words", rank: 4, is_cantrip: false, is_focus: false,
    ...
    desc: "가장 터무니없는 거짓말도 더 믿을 만하게 만듭니다. 기만(Deception) 판정에 <strong>+4 상태 보너스</strong>를 얻습니다." },
  ...
  { name_ko: "수류 격류", name_en: "Hydraulic Torrent", rank: 4, is_cantrip: false, is_focus: false,
    ...
    desc: "강력한 물줄기. <strong>8d6 둔기 피해</strong>(인내). 실패 시 5피트 밀려남. 대실패 시 10피트 밀려남+넘어뜨려짐.<br><strong>강화(+1):</strong> 피해 +2d6." },
  ...
  { name_ko: "평화 방울", name_en: "Peaceful Bubble", rank: 4, is_cantrip: false, is_focus: false,
    ...
    desc: "불투명 방울이 탐지, 꿈, 감지, 투시를 차단합니다. 방울 내부는 외부에서 어떤 마법적 탐지로도 인지할 수 없습니다." },
  ...
  { name_ko: "차원 묶기", name_en: "Planar Tether", rank: 4, is_cantrip: false, is_focus: false,
    ...
    desc: "생물을 현재 차원에 묶어둡니다. 의지 실패 시 차원 이동, 순간이동, 소환 제거 등이 불가." },
  ...
  { name_ko: "예언 읽기", name_en: "Read Omens", rank: 4, is_cantrip: false, is_focus: false,
    ...
    desc: "다가오는 사건에 대한 조언 한 조각을 얻습니다. 특정 목표나 사건에 대해 질문하면 GM이 암호적이지만 유용한 4단어 조언을 줍니다." },
  ...
  { name_ko: "돌 형성", name_en: "Shape Stone", rank: 4, is_cantrip: false, is_focus: false,
    ...
    desc: "돌의 정육면체를 재형성합니다. 원하는 형태로 형성 가능(문, 벽, 선반, 조각 등). 움직이는 부품은 단순한 것만 가능(경첩 등)." },
  ...
  { name_ko: "시체와 대화", name_en: "Talking Corpse", rank: 4, is_cantrip: false, is_focus: false,
    ...
    desc: "시체가 세 가지 질문에 답합니다. 시체는 살아있을 때 알고 있던 정보만 답하며, 거짓말을 할 수 있습니다(일반적으로 성격에 따라)." },
  ...
  { name_ko: "증기 형태", name_en: "Vapor Form", rank: 4, is_cantrip: false, is_focus: false,
    ...
    desc: "몸을 증기로 변합니다. 비행 속도 10피트. 작은 틈을 통과 가능. 물리 피해에 저항 8. 주문시전 및 대부분의 행동 불가. 비마법 바람에 밀릴 수 있음." },
  ...
  { name_ko: "죽음의 환시", name_en: "Vision of Death", rank: 4, is_cantrip: false, is_focus: false,
    ...
    desc: "대상에게 자신의 죽음에 대한 환시를 보여 공포와 정신 피해를 줍니다. <strong>8d6 정신 피해</strong>+공포.<br><strong>성공:</strong> 절반 피해. <strong>실패:</strong> 전체 피해+공포 2. <strong>대실패:</strong> 2배 피해+공포 3+도주 1라운드." },
  ...
  { name_ko: "화염 벽", name_en: "Wall of Fire", rank: 4, is_cantrip: false, is_focus: false,
    ...
    desc: "타오르는 벽을 만들어 통과하는 생물을 태웁니다. 60피트 길이×10피트 높이×1인치 두께. 통과 시 <strong>4d6 화염 피해</strong>. 벽의 한쪽(시전 시 선택)에 인접한 생물이 턴 시작 시 2d6 화염 피해.<br><strong>강화(+1):</strong> 통과 피해 +1d6, 인접 피해 +1d6." },
  ...
  { name_ko: "무기 폭풍", name_en: "Weapon Storm", rank: 4, is_cantrip: false, is_focus: false,
    ...
    desc: "손에 든 무기를 복제하여 많은 생물을 공격합니다. 무기의 피해 주사위를 기반으로 영역 내 모든 생물에 피해(기본 반사).<br><strong>강화(+1):</strong> 피해 주사위 +1개." },
  ...
  { name_ko: "물 제어", name_en: "Control Water", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "물의 수위를 10피트 올리거나 내립니다. 영역 내 물 특성 생물은 인내 내성으로 느리게(slow) 주문의 효과를 받습니다." },
  ...
  { name_ko: "죽음의 저주", name_en: "Curse of Death", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "치명적 저주. 인내 실패 시 <strong>3d6 지속 공허 피해</strong>. 지속 피해를 받는 동안 최대 HP가 해당량만큼 감소. 지속 피해를 멈추면 저주가 잠들지만, 다음 일일 준비 시 저주가 재활성화(인내 내성 재시도).<br><strong>강화(+1):</strong> 지속 피해 +1d6." },
  ...
  { name_ko: "신성한 분신소각", name_en: "Divine Immolation", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "신성한 화염으로 대상에 불을 붙여 반복적으로 태웁니다. 인내 내성과 함께 <strong>5d6 화염 피해</strong>를 가합니다. 실패 또는 대실패 시, 대상에 추가로 불이 붙어 <strong>2d6 지속 화염 피해</strong>를 받으며 10피트 반경에 밝은 빛을, 20피트까지 희미한 빛을 발산합니다. 대실패 시에는 지속 화염 피해가 4d6으로 증가합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> 절반 피해를 받으며 지속 화염 피해는 없습니다.<br><strong>실패:</strong> 전체 피해 및 지속 화염 피해를 받습니다.<br><strong>대실패:</strong> 2배 피해 및 증가된 지속 화염 피해를 받습니다.<br><strong>강화(+1):</strong> 초기 피해 +1d6, 지속 화염 피해 +1d6." },
  ...
  { name_ko: "꿈의 잠재력", name_en: "Dreaming Potential", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "대상이 꿈에서 재훈련합니다. 8시간 수면 후 대상은 1회 재훈련(Retrain)을 완료합니다(보통 1주가 걸리는 것을 하룻밤에)." },
  ...
  { name_ko: "거짓 시야", name_en: "False Vision", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "투시 주문을 속입니다. 영역을 투시하려는 자는 당신이 설정한 환영을 대신 봅니다." },
  ...
  { name_ko: "울부짖는 눈보라", name_en: "Howling Blizzard", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "차가운 바람과 눈더미가 영역을 채웁니다. <strong>7d6 냉기 피해</strong>(기본 반사). 영역은 1라운드간 험지가 됩니다.<br><strong>강화(+1):</strong> 피해 +2d6." },
  ...
  { name_ko: "꿰뚫는 말뚝", name_en: "Impaling Spike", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "냉철 말뚝으로 생물을 꿰뚫습니다. <strong>8d6 관통 피해</strong>(반사). 실패 시 <strong>이동 불가(immobilized)</strong>(말뚝에 꿰뚫림). 탈출 DC = 주문 DC.<br><strong>강화(+1):</strong> 피해 +2d6." },
  ...
  { name_ko: "영혼 소환", name_en: "Invoke Spirits", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "유령 같은 환영을 불러 적을 공격합니다. 생성 시 영역 내 적에 <strong>2d4 영혼 피해+2d4 선택한 에너지 피해</strong>(의지). 유지 시 이동(30피트)+재공격 가능.<br><strong>강화(+2):</strong> 각 피해 +1d4." },
  ...
  { name_ko: "정신 탐침", name_en: "Mind Probe", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "생물의 지식과 기억을 발굴합니다. 특정 정보에 대해 질문하며, 각 유지마다 의지 내성. 실패 시 대상이 알고 있는 정보를 제공합니다. 대상은 탐침을 인지합니다." },
  ...
  { name_ko: "회복의 순간", name_en: "Restorative Moment", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "생물에 하루 분량의 회복을 순간적으로 부여합니다. 대상이 자연 치유로 회복할 HP를 즉시 회복하고, 여러 상태가 하루 경과한 것처럼 줄어듭니다." },
  ...
  { name_ko: "정찰 눈", name_en: "Scouting Eye", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "보이지 않는 눈이 보는 것을 당신에게 전송합니다. 눈은 비행 속도 30피트로 이동하며, 당신의 시각을 대체합니다." },
  ...
  { name_ko: "그림자 폭발", name_en: "Shadow Blast", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "그림자 물질의 피해 원뿔을 형성합니다. 시전 시 피해 유형(산성, 냉기, 전기, 화염, 음파)과 내성(인내, 반사, 의지)을 선택. <strong>5d8 피해</strong>(기본 내성).<br><strong>강화(+1):</strong> 피해 +1d8." },
  ...
  { name_ko: "미끄러짐", name_en: "Slither", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "그림자 뱀이 물고 포획합니다. <strong>4d8 관통 피해</strong>(반사). 실패 시 <strong>조이기(grabbed)</strong>. 유지 시 조이기된 적에 자동 피해 + 이동.<br><strong>강화(+1):</strong> 피해 +1d8." },
  ...
  { name_ko: "돌과 대화", name_en: "Speak with Stones", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "자연 및 가공된 돌과 소통합니다. 돌은 주변에서 일어난 일(누가 지나갔는지, 진동, 온도 변화 등)에 대한 정보를 제공합니다." },
  ...
  { name_ko: "영적 수호자", name_en: "Spiritual Guardian", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "마법의 힘으로 만들어진 중형 수호자가 범위 내 빈 공간에 출현합니다. 수호자는 반투명하며 착용하거나 든 무기 중 하나의 유령 같은 복제본을 지닙니다. 신을 섬기는 경우 수호자는 신의 시종 또는 봉사자 형태를 취합니다. 주문을 성별화하면 수호자의 공격도 성별화됩니다. 생물은 수호자의 공간을 통과할 수 있지만 그 안에 멈출 수 없습니다. 수호자와 협공이 가능합니다. 수호자는 HP 50 외 다른 속성이 없으며 HP는 회복이 불가능하고 아래의 보호 행동을 할 때만 HP를 잃습니다. 주문 시전 시 및 유지 시마다 수호자를 120피트 내 빈 공간으로 이동시키고 다음 중 하나를 수행합니다:<br><strong>공격:</strong> 수호자가 인접한 생물에 근접 주문 명중 굴림을 실행합니다. 명중 시 <strong>3d8 피해</strong>(급소 공격 시 2배). 피해 유형은 무기 유형과 같으며, 영혼 피해가 더 해로우면 영혼 피해로. 다중 공격 페널티에 기여합니다.<br><strong>보호:</strong> 인접한 선택한 생물을 보호합니다. 그 생물이 피해를 받을 때마다 수호자가 대신 피해를 받습니다. 수호자의 HP가 0이 되면 사라지고 주문이 종료됩니다." },
  ...
  { name_ko: "시냅스 파동", name_en: "Synaptic Pulse", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "정신 폭발로 생물을 느리게 합니다. 영역 내 적이 의지 내성 시도.<br><strong>성공:</strong> 느려짐(slowed) 1(1라운드). <strong>실패:</strong> 느려짐 1(1분). <strong>대실패:</strong> 멍해짐(stunned) 1+느려짐 1(1분)." },
  ...
  { name_ko: "염동 운반", name_en: "Telekinetic Haul", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "큰 물체를 이동시킵니다. 대상을 20피트까지 어떤 방향으로든 이동시킵니다. 생물에 떨어지면 피해 가능(기본 반사, 낙하 피해 규칙 적용)." },
  ...
  { name_ko: "지형 전이", name_en: "Terrain Transposition", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "자연 지형을 통해 순간이동합니다. 같은 유형의 자연 지형(숲에서 숲으로, 동굴에서 동굴로) 내에서 최대 120피트까지 순간이동합니다." },
  ...
  { name_ko: "독구름", name_en: "Toxic Cloud", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "독 안개 구름이 당신에게서 굴러갑니다. <strong>4d6 독 피해</strong>(기본 인내). 유지 시 구름이 10피트 이동하고 재피해.<br><strong>강화(+1):</strong> 피해 +1d6." },
  ...
  { name_ko: "그림자 여행", name_en: "Umbral Journey", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "그림자 세계를 통해 빠르게 이동합니다. 물질계에서 그림자계(Netherworld)로 전환되어 이동 속도가 <strong>3배</strong>가 됩니다. 유지 종료 시 물질계의 해당 위치로 돌아옵니다." },
  ...
  { name_ko: "얼음 벽", name_en: "Wall of Ice", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "1피트 두께의 얼음 벽을 형성하여 시야를 차단하고 생물을 냉각시킵니다. 벽의 인접한 면에 있는 생물이 <strong>2d6 냉기 피해</strong>(기본 반사). 벽은 AC 10, 경도 10, HP 40.<br><strong>강화(+2):</strong> HP +20, 피해 +2d6." },
  ...
  { name_ko: "돌 벽", name_en: "Wall of Stone", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "돌 벽을 형성합니다. 120피트 길이, 20피트 높이, 1인치 두께(또는 더 짧고 두껍게). 영구적이지 않지만 물리적으로 파괴하지 않는 한 사라지지 않음. AC 10, 경도 14, HP 50." },
  ...
  { name_ko: "절망의 파도", name_en: "Wave of Despair", rank: 5, is_cantrip: false, is_focus: false,
    ...
    desc: "영역 내 생물을 절망에 빠뜨립니다. 의지 실패 시 <strong>공포 2+느려짐 1</strong>(1라운드). 대실패 시 공포 3+느려짐 1(1분).<br><strong>강화(+1):</strong> 원뿔 크기 +5피트." },
  ...
  { name_ko: "분해", name_en: "Disintegrate", rank: 6, is_cantrip: false, is_focus: false,
    ...
    desc: "검은 추적 볼트를 발사하여 접촉 시 강력한 파괴 광선으로 강화됩니다. 물체나 힘 구조물(힘의 벽 등)에 맞으면 내성 없이 파괴(유물 제외, 최대 10피트 정육면체). 생물에 맞으면 <strong>12d10 피해</strong>(피해 유형 없음, 기본 인내). 치명타 시 내성 결과를 한 단계 나쁘게. 0 HP가 되면 미세한 가루로 분해(장비는 남음).<br><strong>강화(+1):</strong> 피해 +2d10." },
  ...
  { name_ko: "망각", name_en: "Never Mind", rank: 6, is_cantrip: false, is_focus: false,
    ...
    desc: "생물을 영구적으로 멍청하게 만듭니다. 의지 실패 시 <strong>멍청함(stupefied) 4</strong>(영구). 대실패 시 멍청함 4+<strong>혼란(confused) 1라운드</strong>. 이 효과는 저주이며 상쇄로만 제거 가능." },
  ...
  { name_ko: "석화", name_en: "Petrify", rank: 6, is_cantrip: false, is_focus: false,
    ...
    desc: "생물을 돌 조각상으로 만듭니다.<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> 1라운드 느려짐(slowed) 1. <strong>실패:</strong> 1분간 느려짐 1, 매 턴 끝에 인내 내성(실패 시 <strong>석화(petrified) 영구</strong>). <strong>대실패:</strong> <strong>즉시 석화(영구)</strong>." },
  ...
  { name_ko: "환영 재앙", name_en: "Phantasmal Calamity", rank: 6, is_cantrip: false, is_focus: false,
    ...
    desc: "종말의 환시를 만들어 생물에 정신 피해를 줍니다. <strong>11d6 정신 피해</strong>(의지).<br><strong>대성공:</strong> 피해 없음. <strong>성공:</strong> 절반 피해. <strong>실패:</strong> 전체 피해+멍해짐 1(1분). <strong>대실패:</strong> 2배 피해+멍해짐 2(1분).<br><strong>강화(+1):</strong> 피해 +2d6." },
  ...
  { name_ko: "주문 고통", name_en: "Spellwrack", rank: 6, is_cantrip: false, is_focus: false,
    ...
    desc: "주문이 시전될 때 해를 입고 주문 지속 시간이 줄어드는 저주. 의지 실패 시 대상이 주문을 시전하거나 주문의 대상이 될 때마다 <strong>4d6 지속 피해</strong>. 또한 대상의 모든 주문 지속 시간이 절반으로 감소." },
  ...
  { name_ko: "영혼 폭발", name_en: "Spirit Blast", rank: 6, is_cantrip: false, is_focus: false,
    ...
    desc: "생물의 영적 본질에 피해를 줍니다. <strong>16d6 힘 피해</strong>(기본 인내). 영체가 없는 구조물(구조체 등)은 면역.<br><strong>강화(+1):</strong> 피해 +2d6." },
  ...
  { name_ko: "덩굴 뒤엉킴", name_en: "Tangling Creepers", rank: 6, is_cantrip: false, is_focus: false,
    ...
    desc: "폭발 영역에 뒤엉키는 덩굴이 자라 생물을 얽어맵니다. 영역은 험지. 유지 시 덩굴이 영역 내 생물을 공격(인내 DC)하여 이동 불가. 집중 시 덩굴이 추가 피해." },
  ...
  { name_ko: "계절의 나무", name_en: "Tree of Seasons", rank: 6, is_cantrip: false, is_focus: false,
    ...
    desc: "거대한 마법 나무를 자라게 합니다. 나무는 계절에 따른 효과를 줍니다: 봄(치유 발산), 여름(화염 피해 발산), 가을(보호 발산), 겨울(냉기 피해+느리게 발산). 유지 시 계절을 변경할 수 있습니다." },
  ...
  { name_ko: "흡혈 탈혈", name_en: "Vampiric Exsanguination", rank: 6, is_cantrip: false, is_focus: false,
    ...
    desc: "원뿔의 생물에게서 피와 생명력을 빼앗아 자신을 치유합니다. <strong>12d6 공허 피해</strong>(기본 인내). 생물들이 받은 피해의 절반만큼 <strong>임시 HP</strong>를 얻습니다(1분 지속).<br><strong>강화(+1):</strong> 피해 +2d6." },
  ...
  { name_ko: "현란한 무늬", name_en: "Vibrant Pattern", rank: 6, is_cantrip: false, is_focus: false,
    ...
    desc: "빛의 무늬가 영역에 들어오는 생물을 눈부시게 하고 눈멀게 합니다.<br><strong>성공:</strong> 눈부심 1라운드. <strong>실패:</strong> 눈멈 1라운드+눈부심 1분. <strong>대실패:</strong> 눈멈 1분." },
  ...
  { name_ko: "집단 기억", name_en: "Collective Memories", rank: 7, is_cantrip: false, is_focus: false,
    ...
    desc: "주변의 모든 생물의 집단적 기억에 접근합니다. 지역에 대한 역사, 비밀, 숨겨진 정보를 알아낼 수 있습니다. 지식 회상에 <strong>+4 상태 보너스</strong>." },
  ...
  { name_ko: "일식 폭발", name_en: "Eclipse Burst", rank: 7, is_cantrip: false, is_focus: false,
    ...
    desc: "어둠의 구체를 폭발시켜 냉기 피해, 산 것에 추가 피해, 빛을 극복합니다. <strong>8d10 냉기 피해</strong>. 산 것에 추가 <strong>8d4 활력 피해</strong>. 영역의 마법 빛을 상쇄 시도. 불빛은 1분간 꺼짐.<br><strong>강화(+1):</strong> 냉기 +1d10, 활력 +1d4." },
  ...
  { name_ko: "차원 추방", name_en: "Planar Displacement", rank: 7, is_cantrip: false, is_focus: false,
    ...
    desc: "생물을 다른 차원으로 보냅니다. 의지 실패 시 대상이 에테르 차원이나 다른 지정 차원으로 보내집니다. 지속 시간이 끝나면 원래 위치로 돌아옵니다." },
  ...
  { name_ko: "차원 궁전", name_en: "Planar Palace", rank: 7, is_cantrip: false, is_focus: false,
    ...
    desc: "반차원에 안전한 거처를 소환합니다. 내부에 최대 150명 수용. 음식, 침구, 하인(무형) 제공. 외부 위험으로부터 완전 보호." },
  ...
  { name_ko: "차원 봉인", name_en: "Planar Seal", rank: 7, is_cantrip: false, is_focus: false,
    ...
    desc: "순간이동과 소환에 대한 장벽을 세웁니다. 영역 내에서/영역으로의 순간이동, 소환, 차원 이동을 차단합니다." },
  ...
  { name_ko: "투영 이미지", name_en: "Project Image", rank: 7, is_cantrip: false, is_focus: false,
    ...
    desc: "자신의 환영을 만들어 주문을 통해 시전합니다. 환영은 당신처럼 보이고 행동합니다. 유지 시 환영을 통해 주문을 시전할 수 있습니다(사거리는 환영 위치에서 계산)." },
  ...
  { name_ko: "정밀 대상", name_en: "True Target", rank: 7, is_cantrip: false, is_focus: false,
    ...
    desc: "한 생물에 대한 여러 공격을 특별히 정확하게 합니다. 이 턴과 다음 턴에 대상에 대한 명중 굴림에서 <strong>d20을 두 번 굴려 높은 것을 사용</strong>." },
  ...
  { name_ko: "화산 분출", name_en: "Volcanic Eruption", rank: 7, is_cantrip: false, is_focus: false,
    ...
    desc: "미니 화산을 폭발시킵니다. 분출구에서 30피트 원뿔의 용암이 분출되어 <strong>14d6 화염 피해</strong>(반사). 실패 시 <strong>4d6 지속 화염 피해</strong>. 분출구 영역은 <strong>극심 험지</strong>가 됩니다(1분).<br><strong>강화(+1):</strong> 화염 +2d6." },
  ...
  { name_ko: "정신 왜곡", name_en: "Warp Mind", rank: 7, is_cantrip: false, is_focus: false,
    ...
    desc: "생물을 혼란시켜 영구적으로 만듭니다. 의지 실패 시 <strong>혼란(confused)</strong>. 대실패 시 <strong>영구 혼란</strong>(상쇄로만 제거)." },
  ...
  { name_ko: "극지 균열", name_en: "Arctic Rift", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "매서운 추위가 생물에 피해를 주고 얼립니다. <strong>10d8 냉기 피해</strong>(기본 반사). 실패 시 <strong>느려짐(slowed) 2</strong>(1라운드). 대실패 시 <strong>석화(petrified, 얼음으로)</strong>(1분).<br><strong>강화(+1):</strong> 피해 +2d8." },
  ...
  { name_ko: "영원한 슬픔의 찬가", name_en: "Canticle of Everlasting Grief", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "순수한 슬픔에서 증류된 선율. <strong>10d6 정신 피해</strong>. 저주받은 동안 상황/상태 보너스를 받을 수 없음.<br><strong>성공:</strong> 절반 피해, 공포 1, 저주 1라운드. <strong>실패:</strong> 전체 피해, 공포 2, 저주 1분. <strong>대실패:</strong> 2배 피해, 공포 3+도주 1라운드, 저주 10분." },
  ...
  { name_ko: "탈수", name_en: "Desiccate", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "대상의 수분을 빼앗아 <strong>10d10 공허 피해</strong>. 물 생물과 식물 생물은 내성 결과를 한 단계 나쁘게 적용. 수분이 없는 생물(대지 정령 등)은 면역.<br><strong>강화(+1):</strong> 피해 +1d10." },
  ...
  { name_ko: "소멸", name_en: "Disappearance", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "생물을 모든 감각에서 숨깁니다. 대상이 <strong>미탐지(undetected)</strong> 상태가 됩니다 — 시각뿐만 아니라 모든 정밀/부정확 감각에서. 탐색(Seek), 흩어진 먼지, 소리 공백 등으로 발견 가능." },
  ...
  { name_ko: "지진", name_en: "Earthquake", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "파괴적인 지진으로 땅을 흔듭니다. 영역이 험지가 됩니다. 생물이 반사 내성 시도.<br><strong>대성공:</strong> 영향 없음. <strong>성공:</strong> 넘어뜨려짐. <strong>실패:</strong> 넘어뜨려짐+<strong>4d6 둔기 피해</strong>. <strong>대실패:</strong> 넘어뜨려짐+<strong>4d6 둔기 피해</strong>+<strong>1d6 지속 둔기 피해</strong>. 구조물에 추가 피해.<br><strong>강화(+1):</strong> 둔기 피해 +1d6." },
  ...
  { name_ko: "숨겨진 정신", name_en: "Hidden Mind", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "정신 마법과 비밀을 엿보는 효과로부터 생물을 보호합니다. 정신 효과에 대한 내성에 +2 상태 보너스. 독심술, 투시, 기타 탐지 효과에 면역." },
  ...
  { name_ko: "이주", name_en: "Migration", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "당신과 동의하는 생물들을 같은 차원 내 먼 거리로 순간이동시킵니다. 순간이동(Teleport)과 유사하지만 더 많은 대상을 이동시킬 수 있으며, 야외 자연 환경으로만 이동 가능합니다." },
  ...
  { name_ko: "갱신의 순간", name_en: "Moment of Renewal", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "생물에 하루 분량의 회복을 순간적으로 부여합니다. 각 대상이 <strong>4d8+21 HP 회복</strong>. 또한 각 대상에게 영향을 미치는 저주, 질병, 독 중 하나에 대해 상쇄를 시도합니다. 추가로 배수(drained) 수치를 1 감소시킵니다." },
  ...
  { name_ko: "괴물 형태", name_en: "Monstrosity Form", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "강력한 괴물로 변신합니다. 거대 크기, AC=22+레벨, 임시 HP 20. 피닉스, 크라켄, 퍼플 웜, 베히르 등 선택. 각 형태마다 고유 공격, 이동 속도, 특수 능력." },
  ...
  { name_ko: "정확 위치", name_en: "Pinpoint", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "생물이나 물체의 정확한 위치를 알아냅니다. 대상에 대해 아는 것이 있으면 성공적으로 위치를 파악합니다." },
  ...
  { name_ko: "벌의 바람", name_en: "Punishing Winds", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "강력한 바람이 영역을 휩씁니다. 원거리 공격에 -4 상황 페널티. 비행 중인 생물은 60피트 하강(인내로 저항). 영역은 극심 험지. 소형 이하 생물은 이동 불가." },
  ...
  { name_ko: "난제", name_en: "Quandary", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "초차원 퍼즐에 생물을 가둡니다. 의지 실패 시 대상이 반차원 퍼즐 공간에 갇힙니다. 탈출하려면 다양한 기술 판정(주문 DC) 3번 성공 필요." },
  ...
  { name_ko: "억제할 수 없는 춤", name_en: "Uncontrollable Dance", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "춤에 대한 억제할 수 없는 충동으로 대상을 극복합니다. 의지 실패 시 대상이 매 턴 1행동을 춤추는 데 사용해야 합니다(방심+이동 속도 -10피트). 대실패 시 모든 행동을 춤에 사용." },
  ...
  { name_ko: "끊임없는 관찰", name_en: "Unrelenting Observation", rank: 8, is_cantrip: false, is_focus: false,
    ...
    desc: "당신과 다른 생물이 투시를 사용하여 대상을 정확히 추적합니다. 대상이 영역을 통과하면, 당신은 대상의 정확한 위치를 다음 일일 준비까지 알 수 있습니다." },
  ...
  { name_ko: "마법 폭발", name_en: "Detonate Magic", rank: 9, is_cantrip: false, is_focus: false,
    ...
    desc: "대상의 마법을 파괴적 폭발로 소산시킵니다. 상쇄를 시도합니다. 성공 시 <strong>8d6 힘 피해</strong>의 폭발(기본 반사). 아이템이면 1주 비활성(대성공 시 파괴), 5피트 발산. 주문이면 효과 종료, 영역 내 모든 생물 또는 대상+5피트 발산에 영향." },
  ...
  { name_ko: "압도적 존재", name_en: "Overwhelming Presence", rank: 9, is_cantrip: false, is_focus: false,
    ...
    desc: "신의 위엄을 취합니다. 영역 내 적이 의지 내성 시도. 실패 시 <strong>매 턴 첫 행동을 절하기(엎드리기)에 사용</strong>해야 합니다(1분). 대실패 시 추가로 <strong>멍해짐 1</strong>." },
  ...
  { name_ko: "환상 공포증", name_en: "Phantasmagoria", rank: 9, is_cantrip: false, is_focus: false,
    ...
    desc: "겁먹게 하고 정신 피해를 주며 대상을 죽일 수도 있습니다. <strong>16d6 정신 피해</strong>. 공포 1(성공), 공포 2(실패), 공포 3+도주(대실패). 대실패 시 피해가 0 HP로 만들면 <strong>공포로 사망</strong>." },
  ...
  { name_ko: "영혼 포획", name_en: "Seize Soul", rank: 9, is_cantrip: false, is_focus: false,
    ...
    desc: "영혼을 아이템에 가둡니다. 죽은 생물의 영혼이 보석에 포획되어 부활이나 다른 사후 효과가 불가능해집니다. 보석을 파괴하면 영혼이 해방됩니다." },
  ...
  { name_ko: "불가해한 노래", name_en: "Unfathomable Song", rank: 9, is_cantrip: false, is_focus: false,
    ...
    desc: "이해할 수 없는 노래. 적이 의지 내성 시도. <strong>성공:</strong> 멍청함 1(1라운드). <strong>실패:</strong> 혼란+멍청함 1(1라운드). <strong>대실패:</strong> 지배(controlled, 1라운드)+멍청함 1. 유지 시 영역 내 적에 재적용." },
  ...
  { name_ko: "저주받은 자의 울부짖음", name_en: "Wails of the Damned", rank: 9, is_cantrip: false, is_focus: false,
    ...
    desc: "비명을 질러 산 것의 생명력을 빼앗고 공허 피해를 줍니다. <strong>8d10 음파 피해 + 8d10 공허 피해</strong>(기본 인내). 산 것에만 영향." },
  ...
  { name_ko: "분노의 폭풍", name_en: "Wrathful Storm", rank: 9, is_cantrip: false, is_focus: false,
    ...
    desc: "격렬한 뇌우. 생성 시 <strong>2d12 전기 피해</strong>(기본 반사). 유지 시 원하는 칸에 번개 낙뢰(각 <strong>4d12 전기</strong>, 기본 반사)." },
  ...
  { name_ko: "대재앙", name_en: "Cataclysm", rank: 10, is_cantrip: false, is_focus: false,
    ...
    desc: "즉각적이고 파괴적인 대재앙을 불러옵니다. 영역 내 저항을 10 낮게 취급. 모든 생물이 기본 반사 1회로 5종 피해를 동시에 받습니다: 산성 비 3d10, 지진 3d10 둔기, 동결 바람 3d10 냉기, 번개 3d10 전기, 비행 중 돌풍 3d10 둔기, 쓰나미 3d10 둔기(수영 중 2배), 산불 3d10 화염." },
  ...
  { name_ko: "무적", name_en: "Indestructibility", rank: 10, is_cantrip: false, is_focus: false,
    ...
    desc: "잠시 모든 것에 면역이 됩니다. 다음 턴 시작까지 <strong>모든 피해와 해로운 효과에 면역</strong>." },
  ...
  { name_ko: "자연의 화신", name_en: "Nature Incarnate", rank: 10, is_cantrip: false, is_focus: false,
    ...
    desc: "자연의 궁극적 화신으로 변신합니다. 가루다, 카라킨(세계 거북), 베히모스 등 자연의 가장 강력한 형태 중 하나를 취합니다. 거대 크기, AC=25+레벨, 임시 HP 30, 공격 수정치 +33." },
  ...
  { name_ko: "재창조", name_en: "Remake", rank: 10, is_cantrip: false, is_focus: false,
    ...
    desc: "파괴된 물체를 다시 만듭니다. 파괴된 물체의 조각(아무리 작아도)을 원래 상태로 복원합니다. 유물(artifact)에는 작동하지 않습니다." },
  ...
  { name_ko: "부흥", name_en: "Revival", rank: 10, is_cantrip: false, is_focus: false,
    ...
    desc: "영역 내 생물을 치유하고 죽은 자를 일시적으로 되살립니다. 살아있는 아군은 <strong>10d8+40 HP 회복</strong>. 최근 1분 이내 사망한 생물은 <strong>1 HP</strong>로 부활합니다." },
