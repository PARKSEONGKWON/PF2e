...
const SPELL_DB = [
  ...
  { name_ko: "멍하게",
    ...
    defense: "의지",
    duration: "1라운드",
    summary: "대상의 정신을 흐리게 하여 무방비하거나 느리게 만듭니다.대성공: 영향 없음.성공: 대상이 1라운드간 무방비(off-guard).실패: 대상이 4 정신 피해를 받고 1라운드간 무방비.대실패: 대상이 4 정신 피해를 받고 1라운드간 무방비 + 느려짐 1(slowed 1).강화(+2): 피해 +4.",
  ...
  { name_ko: "허상",
    ...
    range: "30피트",
    duration: "유지(최대 1분)",
    summary: "간단한 청각적 또는 시각적 환영을 만듭니다. 소리만이면 대화를 모방할 수 없고, 이미지라면 5피트 정육면체 안에 맞아야 하며 움직이지 못합니다. 환영은 다른 감각을 만들 수 없습니다. 생물이 환영을 탐색(Seek)하면 주문 DC에 대한 지각 판정으로 불신할 수 있습니다.",
    desc: "<strong>사거리:</strong> 30피트<br><strong>지속 시간:</strong> 유지(최대 1분)<br>간단한 청각적 또는 시각적 환영을 만듭니다. 소리만이면 대화를 모방할 수 없고, 이미지라면 5피트 정육면체 안에 맞아야 하며 움직이지 못합니다. 환영은 다른 감각을 만들 수 없습니다. 생물이 환영을 탐색(Seek)하면 주문 DC에 대한 지각 판정으로 불신할 수 있습니다." },
  ...
  { name_ko: "발톱 긁기",
    ...
    target: "인접한 생물 1",
    defense: "AC",
    summary: "팔을 발톱으로 변형시켜 공격합니다. 주문 명중 굴림을 합니다. 성공 시 1d6 참격 피해를 가합니다. 치명타 시 대상이 1d4 지속 출혈 피해를 받습니다. 피해 유형은 관통으로 변경 가능합니다.강화(+1): 참격 피해 +1d6, 지속 출혈 +1d4.",
    desc: "<strong>대상:</strong> 인접한 생물 1<br><strong>방어:</strong> AC<br>팔을 발톱으로 변형시켜 공격합니다. 주문 명중 굴림을 합니다. 성공 시 <strong>1d6 참격 피해</strong>를 가합니다. 치명타 시 대상이 <strong>1d4 지속 출혈 피해</strong>를 받습니다. 피해 유형은 관통으로 변경 가능합니다.<br><strong>강화(+1):</strong> 참격 피해 +1d6, 지속 출혈 +1d4." },
  ...
  { name_ko: "인도",
    ...
    target: "생물 1",
    duration: "다음 턴 시작까지",
    summary: "신성한 인도가 하나의 굴림을 향상시킵니다. 대상이 지속 시간 중 하나의 명중 굴림, 기술 판정, 또는 내성 굴림에 +1 상태 보너스를 사용할 수 있습니다. 보너스를 사용하면 주문이 종료됩니다. 생물이 인도를 받으면 1시간 동안 다시 인도의 대상이 될 수 없습니다.",
    desc: "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 다음 턴 시작까지<br>신성한 인도가 하나의 굴림을 향상시킵니다. 대상이 지속 시간 중 하나의 명중 굴림, 기술 판정, 또는 내성 굴림에 <strong>+1 상태 보너스</strong>를 사용할 수 있습니다. 보너스를 사용하면 주문이 종료됩니다. 생물이 인도를 받으면 <strong>1시간 동안</strong> 다시 인도의 대상이 될 수 없습니다." },
  ...
  { name_ko: "염동 투사",
    ...
    desc: "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> AC<br>물체를 염동력으로 발사하여 적에게 날립니다. 주문 명중 굴림을 합니다. 성공 시 <strong>1d6 둔기, 관통, 또는 참격 피해</strong>(발사한 물체에 적합한 유형, 시전 시 선택)를 가합니다.<br><strong>강화(+1):</strong> 피해 +1d6." },
  ...
  { name_ko: "죽음의 디르지",
    ...
    desc: "<strong>영역:</strong> 30피트 발산<br><strong>지속 시간:</strong> 1라운드<br>영역 내 적은 <strong>공포(frightened) 1</strong>이 됩니다. 영역 내에 남아 있는 동안 공포 수치를 <strong>1 미만으로 줄일 수 없습니다</strong>." },
  ...
  { name_ko: "알레그로",
    ...
    desc: "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 아군 1<br><strong>지속 시간:</strong> 1라운드<br>빠르게 연주하여 아군의 속도를 높입니다. 대상은 <strong>가속(quickened)</strong> 상태가 되어 추가 행동을 얻으며, 이 추가 행동은 <strong>타격(Strike), 보폭(Stride), 또는 걸음(Step)</strong>에만 사용할 수 있습니다." },
  ...
  { name_ko: "진실의 말씀",
    ...
    desc: "<strong>지속 시간:</strong> 1라운드<br>진실만 말할 수 있게 됩니다. 지속 시간 동안 당신은 의도적으로 거짓말을 할 수 없으며, 다른 생물이 이를 인지합니다. 기만에 대한 지각 판정에 <strong>+4 상태 보너스</strong>." },
  ...
  { name_ko: "개미 운반",
    ...
    target: "생물 1",
    duration: "8시간",
    summary: "대상이 더 많이 운반할 수 있게 합니다. 대상의 과부하 한계를 결정할 때 근력 수정치를 3 높은 것처럼 취급합니다. 이것은 대상의 실제 근력 수정치나 근력 기반 판정에는 영향을 주지 않으며, 운반할 수 있는 부피량만 증가시킵니다.",
    desc: "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 8시간<br>대상이 더 많이 운반할 수 있게 합니다. 대상의 과부하 한계를 결정할 때 근력 수정치를 <strong>3 높은 것</strong>처럼 취급합니다. 이것은 대상의 실제 근력 수정치나 근력 기반 판정에는 영향을 주지 않으며, 운반할 수 있는 부피량만 증가시킵니다." },
  ...
  { name_ko: "재앙",
    ...
    defense: "의지",
    duration: "1분",
    summary: "영역 내 적의 마음에 의심과 불확실성을 심어 넣습니다. 영역에 있는 각 적은 의지 내성을 시도해야 합니다. 의지 내성에 실패한 생물은 주문의 지속 시간 동안 명중 굴림에 -1 상태 페널티를 받습니다. 영역을 벗어나도 페널티가 유지되지만, 다시 영역에 들어온 생물은 새로운 내성을 시도하지 않습니다.주문을 유지할 때마다, 영역의 반경이 10피트씩 증가합니...",
    desc: "<strong>영역:</strong> 10피트 발산<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1분<br>영역 내 적의 마음에 의심과 불확실성을 심어 넣습니다. 영역에 있는 각 적은 의지 내성을 시도해야 합니다. 의지 내성에 실패한 생물은 주문의 지속 시간 동안 명중 굴림에 <strong>-1 상태 페널티</strong>를 받습니다. 영역을 벗어나도 페널티가 유지되지만, 다시 영역에 들어온 생물은 새로운 내성을 시도하지 않습니다.<br>주문을 <strong>유지</strong>할 때마다, 영역의 반경이 <strong>10피트</strong>씩 증가합니다(최대 30피트 발산). 새로 영역에 포함된 적은 새로운 의지 내성을 시도합니다.<br>재앙(bane)은 축복(bless)과 상쇄됩니다. 영역이 겹치면 두 주문 모두 겹치는 영역에서 효력을 잃습니다." },
  ...
  { name_ko: "축복",
    ...
    area: "10피트 발산",
    duration: "1분",
    summary: "축복이 영역 내 아군(자신 포함)에게 전투력을 고양시킵니다. 영역 내 당신을 포함한 아군은 명중 굴림에 +1 상태 보너스를 받습니다. 영역을 벗어나면 즉시 보너스가 사라지지만, 영역에 다시 들어오면 보너스를 다시 받습니다.주문을 유지할 때마다, 영역의 반경이 10피트씩 증가합니다(최대 30피트 발산).축복(bless)과 재앙(bane)은 상쇄됩니다. ...",
    desc: "<strong>영역:</strong> 10피트 발산<br><strong>지속 시간:</strong> 1분<br>축복이 영역 내 아군(자신 포함)에게 전투력을 고양시킵니다. 영역 내 당신을 포함한 아군은 명중 굴림에 <strong>+1 상태 보너스</strong>를 받습니다. 영역을 벗어나면 즉시 보너스가 사라지지만, 영역에 다시 들어오면 보너스를 다시 받습니다.<br>주문을 <strong>유지</strong>할 때마다, 영역의 반경이 <strong>10피트</strong>씩 증가합니다(최대 30피트 발산).<br>축복(bless)과 재앙(bane)은 상쇄됩니다. 영역이 겹치면 두 주문 모두 겹치는 영역에서 효력을 잃습니다." },
  ...
  { name_ko: "쇠약",
    ...
    desc: "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 인내<br><strong>지속 시간:</strong> 1분<br>대상의 근육과 힘줄을 약화시키는 에너지를 보냅니다. 대상은 인내 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> 주문의 지속 시간 동안 <strong>약화(enfeebled) 1</strong> 상태가 됩니다.<br><strong>실패:</strong> 주문의 지속 시간 동안 <strong>약화 2</strong> 상태가 됩니다.<br><strong>대실패:</strong> 주문의 지속 시간 동안 <strong>약화 3</strong> 상태가 됩니다." },
  ...
  { name_ko: "힘의 포격",
    ...
    range: "30피트",
    target: "생물 1~3",
    summary: "오류 없는 마법 힘의 파편으로 생물을 강타합니다. 1행동 시 1발(1d4+1 힘 피해), 2행동 시 2발, 3행동 시 3발. 각 탄을 같은 대상이나 다른 대상에 배분할 수 있습니다. 명중 굴림 없이 자동 명중.강화(+2): 탄 1발 추가.",
    desc: "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1~3<br>오류 없는 마법 힘의 파편으로 생물을 강타합니다. 1행동 시 <strong>1발(1d4+1 힘 피해)</strong>, 2행동 시 <strong>2발</strong>, 3행동 시 <strong>3발</strong>. 각 탄을 같은 대상이나 다른 대상에 배분할 수 있습니다. <strong>명중 굴림 없이 자동 명중.</strong><br><strong>강화(+2):</strong> 탄 1발 추가." },
  ...
  { name_ko: "암울한 촉수",
    ...
    area: "60피트 직선",
    defense: "기본 인내",
    summary: "음산한 공허 에너지의 촉수가 60피트 직선으로 뻗어나갑니다. 직선 경로에 있는 각 살아있는 생물은 2d4 공허 피해를 받고 기본 인내 내성을 시도합니다. 내성에 실패한 생물은 추가로 1 지속 출혈 피해를 받습니다.강화(+1): 공허 피해 +2d4, 지속 출혈 피해 +1.",
    desc: "<strong>영역:</strong> 60피트 직선<br><strong>방어:</strong> 기본 인내<br>음산한 공허 에너지의 촉수가 60피트 직선으로 뻗어나갑니다. 직선 경로에 있는 각 살아있는 생물은 <strong>2d4 공허 피해</strong>를 받고 <strong>기본 인내 내성</strong>을 시도합니다. 내성에 실패한 생물은 추가로 <strong>1 지속 출혈 피해</strong>를 받습니다.<br><strong>강화(+1):</strong> 공허 피해 +2d4, 지속 출혈 피해 +1." },
  ...
  { name_ko: "돌풍",
    ...
    traits: ["공기","조작"],
    area: "60피트 직선",
    summary: "강력한 돌풍이 60피트 직선으로 불어나갑니다. 경로에 있는 비마법 화염은 자동으로 꺼집니다. 직선 경로에 있는 각 생물은 인내 내성을 시도합니다.대성공: 영향 없음.성공: 영향 없음.실패: 중형 이하 생물은 5피트 밀려납니다. 비행 중인 생물은 10피트 밀려납니다.대실패: 중형 이하 생물은 10피트 밀려나고 넘어뜨려집니다. 비행 중인 생물은 20피트 ...",
    desc: "<strong>영역:</strong> 60피트 직선<br>강력한 돌풍이 60피트 직선으로 불어나갑니다. 경로에 있는 비마법 화염은 자동으로 꺼집니다. 직선 경로에 있는 각 생물은 인내 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> 영향 없음.<br><strong>실패:</strong> 중형 이하 생물은 <strong>5피트</strong> 밀려납니다. 비행 중인 생물은 <strong>10피트</strong> 밀려납니다.<br><strong>대실패:</strong> 중형 이하 생물은 <strong>10피트</strong> 밀려나고 넘어뜨려집니다. 비행 중인 생물은 <strong>20피트</strong> 밀려납니다." },
  ...
  { name_ko: "해로움",
    ...
    actions: "1~3행동",
    traits: ["조작","공허"],
    summary: "공허 에너지를 방출하여 살아있는 생물을 해치거나 언데드를 치유합니다. 소비하는 행동 수에 따라 효과가 달라집니다.[1행동](집중) 접촉 대상 1명에게 1d8 공허 피해(살아있는 생물에게) 또는 1d8 HP 회복(언데드에게).[2행동](집중, 조작) 30피트 사거리, 대상 1명에게 같은 효과.[3행동](집중, 조작) 30피트 발산 영역 내 모든 생물에 ...",
    desc: "공허 에너지를 방출하여 살아있는 생물을 해치거나 언데드를 치유합니다. 소비하는 행동 수에 따라 효과가 달라집니다.<br><strong>[1행동]</strong>(집중) 접촉 대상 1명에게 <strong>1d8 공허 피해</strong>(살아있는 생물에게) 또는 <strong>1d8 HP 회복</strong>(언데드에게).<br><strong>[2행동]</strong>(집중, 조작) 30피트 사거리, 대상 1명에게 같은 효과.<br><strong>[3행동]</strong>(집중, 조작) 30피트 발산 영역 내 모든 생물에 영향. 살아있는 생물에게는 피해(기본 인내), 언데드에게는 회복(내성 없음).<br><strong>강화(+1):</strong> 피해/회복 +1d8. 3행동 시전 시 피해/회복이 +1d8 대신 +1d10." },
  ...
  { name_ko: "치유",
    ...
    actions: "1~3행동",
    traits: ["치유","조작","활력"],
    summary: "활력 에너지를 방출하여 살아있는 생물을 치유하거나 언데드를 해칩니다. 소비하는 행동 수에 따라 효과가 달라집니다.[1행동](집중) 접촉 대상 1명에게 1d8 HP 회복(살아있는 생물에게) 또는 1d8 활력 피해(언데드에게).[2행동](집중, 조작) 30피트 사거리, 대상 1명에게 같은 효과.[3행동](집중, 조작) 30피트 발산 영역 내 모든 생물에 ...",
    desc: "활력 에너지를 방출하여 살아있는 생물을 치유하거나 언데드를 해칩니다. 소비하는 행동 수에 따라 효과가 달라집니다.<br><strong>[1행동]</strong>(집중) 접촉 대상 1명에게 <strong>1d8 HP 회복</strong>(살아있는 생물에게) 또는 <strong>1d8 활력 피해</strong>(언데드에게).<br><strong>[2행동]</strong>(집중, 조작) 30피트 사거리, 대상 1명에게 같은 효과.<br><strong>[3행동]</strong>(집중, 조작) 30피트 발산 영역 내 모든 생물에 영향. 살아있는 생물에게는 회복(내성 없음), 언데드에게는 피해(기본 인내).<br><strong>강화(+1):</strong> 피해/회복 +1d8. 3행동 시전 시 피해/회복이 +1d8 대신 +1d10." },
  ...
  { name_ko: "수류 밀기",
    ...
    target: "생물 1",
    defense: "인내",
    summary: "고압 물의 폭발이 대상을 강타합니다. 대상은 3d6 둔기 피해를 받고 인내 내성을 시도합니다.대성공: 피해 없음.성공: 절반 피해.실패: 전체 피해를 받고, 당신에게서 5피트 밀려납니다.대실패: 2배 피해를 받고, 당신에게서 10피트 밀려나며, 넘어뜨려짐(prone) 상태가 됩니다.강화(+1): 피해 +2d6.",
    desc: "<strong>사거리:</strong> 60피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 인내<br>고압 물의 폭발이 대상을 강타합니다. 대상은 <strong>3d6 둔기 피해</strong>를 받고 인내 내성을 시도합니다.<br><strong>대성공:</strong> 피해 없음.<br><strong>성공:</strong> 절반 피해.<br><strong>실패:</strong> 전체 피해를 받고, 당신에게서 <strong>5피트</strong> 밀려납니다.<br><strong>대실패:</strong> 2배 피해를 받고, 당신에게서 <strong>10피트</strong> 밀려나며, <strong>넘어뜨려짐(prone)</strong> 상태가 됩니다.<br><strong>강화(+1):</strong> 피해 +2d6." },
  ...
  { name_ko: "신비 갑옷",
    ...
    traits: ["조작"],
    duration: "다음 일일 준비까지",
    summary: "비가시적인 마법 방어막이 당신을 감싸 보호합니다. AC에 +1 아이템 보너스를 얻습니다. 갑옷을 착용하고 있으면 이 주문은 효과가 없습니다(갑옷의 아이템 보너스와 중첩되지 않음).강화(4랭크): AC에 +2 아이템 보너스.강화(6랭크): AC에 +3 아이템 보너스.강화(8랭크): AC에 +4 아이템 보너스.",
    desc: "<strong>지속 시간:</strong> 다음 일일 준비까지<br>비가시적인 마법 방어막이 당신을 감싸 보호합니다. AC에 <strong>+1 아이템 보너스</strong>를 얻습니다. 갑옷을 착용하고 있으면 이 주문은 효과가 없습니다(갑옷의 아이템 보너스와 중첩되지 않음).<br><strong>강화(4랭크):</strong> AC에 <strong>+2</strong> 아이템 보너스.<br><strong>강화(6랭크):</strong> AC에 <strong>+3</strong> 아이템 보너스.<br><strong>강화(8랭크):</strong> AC에 <strong>+4</strong> 아이템 보너스." },
  ...
  { name_ko: "뇌격",
    ...
    target: "생물 1",
    defense: "기본 반사",
    summary: "하늘에서 벼락이 내리쳐 대상을 강타합니다. 대상은 1d12 전기 피해와 1d4 음파 피해를 받고 기본 반사 내성을 시도합니다. 내성에 실패한 금속 갑옷을 입은 생물은 추가로 1 지속 전기 피해를 받습니다.강화(+1): 전기 피해 +1d12, 음파 피해 +1d4.",
    desc: "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 기본 반사<br>하늘에서 벼락이 내리쳐 대상을 강타합니다. 대상은 <strong>1d12 전기 피해</strong>와 <strong>1d4 음파 피해</strong>를 받고 <strong>기본 반사 내성</strong>을 시도합니다. 내성에 실패한 금속 갑옷을 입은 생물은 추가로 <strong>1 지속 전기 피해</strong>를 받습니다.<br><strong>강화(+1):</strong> 전기 피해 +1d12, 음파 피해 +1d4." },
  ...
  { name_ko: "복화술",
    ...
    desc: "<strong>지속 시간:</strong> 10분<br>목소리를 던집니다. 60피트 이내의 다른 위치에서 목소리가 나오는 것처럼 만듭니다. 지각 판정으로 불신 가능.<br><strong>강화(3랭크):</strong> 사거리 500피트." },
  ...
  { name_ko: "산성 집게",
    ...
    defense: "인내",
    duration: "유지(최대 1분)",
    summary: "부식성 산성으로 된 손을 소환하여 적을 붙잡고 녹입니다. 대상은 3d6 산성 피해를 받고 인내 내성을 시도합니다.대성공: 영향 없음.성공: 절반 피해.실패: 전체 피해를 받고 산성 손에 조이기(grabbed) 상태가 됩니다.대실패: 2배 피해를 받고 산성 손에 억제(restrained) 상태가 됩니다.주문을 유지할 때마다, 조이기 또는 억제 상태인 대...",
    desc: "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 인내<br><strong>지속 시간:</strong> 유지(최대 1분)<br>부식성 산성으로 된 손을 소환하여 적을 붙잡고 녹입니다. 대상은 <strong>3d6 산성 피해</strong>를 받고 인내 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> 절반 피해.<br><strong>실패:</strong> 전체 피해를 받고 산성 손에 <strong>조이기(grabbed)</strong> 상태가 됩니다.<br><strong>대실패:</strong> 2배 피해를 받고 산성 손에 <strong>억제(restrained)</strong> 상태가 됩니다.<br>주문을 유지할 때마다, 조이기 또는 억제 상태인 대상은 <strong>1d6 산성 피해</strong>를 받습니다(내성 없음). 대상은 주문 DC에 대해 탈출(Escape)을 시도할 수 있습니다.<br><strong>강화(+2):</strong> 초기 피해 +3d6, 유지 피해 +1d6." },
  ...
  { name_ko: "흐림",
    ...
    target: "생물 1",
    duration: "1분",
    summary: "대상의 형체가 흐릿하게 일그러지고, 윤곽이 불분명해집니다. 대상은 은폐(concealed) 상태가 됩니다. 은폐된 생물을 공격하려면 DC 5 단순 판정에 성공해야 하며, 실패하면 공격이 빗나갑니다. 이것은 환영이므로 진실 시야(truesight) 같은 정밀한 감각이나 환영을 무시하는 능력으로 이 효과를 무시할 수 있습니다.",
    desc: "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 1분<br>대상의 형체가 흐릿하게 일그러지고, 윤곽이 불분명해집니다. 대상은 <strong>은폐(concealed)</strong> 상태가 됩니다. 은폐된 생물을 공격하려면 DC 5 단순 판정에 성공해야 하며, 실패하면 공격이 빗나갑니다. 이것은 환영이므로 <strong>진실 시야(truesight)</strong> 같은 정밀한 감각이나 환영을 무시하는 능력으로 이 효과를 무시할 수 있습니다." },
  ...
  { name_ko: "안개",
    ...
    desc: "<strong>사거리:</strong> 120피트<br><strong>영역:</strong> 20피트 폭발<br><strong>지속 시간:</strong> 1분<br>짙은 안개 구름이 영역을 뒤덮습니다. 영역 내의 모든 생물과 물체는 <strong>은폐(concealed)</strong> 상태가 됩니다. 은폐된 대상을 공격하려면 DC 5 단순 판정에 성공해야 하며, 실패하면 공격이 빗나갑니다. 강한 바람은 안개를 날려 보낼 수 있습니다." },
  ...
  { name_ko: "평화로운 안식",
    ...
    target: "시체 1",
    duration: "다음 일일 준비까지",
    summary: "시체에 보호 마법을 부여합니다. 주문의 지속 시간 동안 시체가 부패하지 않으며, 언데드로 일으키려는 시도에 면역이 됩니다. 이 주문은 부활 주문에 필요한 시간 제한을 연장하는 데 유용합니다.",
    desc: "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 시체 1<br><strong>지속 시간:</strong> 다음 일일 준비까지<br>시체에 보호 마법을 부여합니다. 주문의 지속 시간 동안 시체가 <strong>부패하지 않으며</strong>, 언데드로 일으키려는 시도에 <strong>면역</strong>이 됩니다. 이 주문은 부활 주문에 필요한 시간 제한을 연장하는 데 유용합니다." },
  ...
  { name_ko: "침묵",
    ...
    target: "동의 생물 1",
    duration: "1분",
    summary: "동의하는 생물에서 나오는 모든 소리를 마법적으로 음소거합니다. 대상은 어떤 소리도 내지 않으며, 언어(verbal) 구성요소가 필요한 주문을 시전할 수 없고, 청각(auditory) 특질을 가진 효과를 사용할 수 없습니다. 대상의 발걸음 소리, 무기 충돌 소리, 기타 모든 소리가 완전히 차단되어 은밀 행동에 유리합니다.강화(4랭크): 대상 대신 15피...",
    desc: "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 동의 생물 1<br><strong>지속 시간:</strong> 1분<br>동의하는 생물에서 나오는 모든 소리를 마법적으로 음소거합니다. 대상은 어떤 소리도 내지 않으며, 언어(verbal) 구성요소가 필요한 주문을 시전할 수 없고, 청각(auditory) 특질을 가진 효과를 사용할 수 없습니다. 대상의 발걸음 소리, 무기 충돌 소리, 기타 모든 소리가 완전히 차단되어 은밀 행동에 유리합니다.<br><strong>강화(4랭크):</strong> 대상 대신 <strong>15피트 발산</strong> 영역으로 변경됩니다. 영역 내에서 발생하는 모든 소리가 차단되며, 소리는 영역 안으로 들어오거나 나갈 수 없습니다." },
  ...
  { name_ko: "수구",
    ...
    defense: "반사",
    duration: "유지(최대 1분)",
    summary: "거대한 물의 공을 소환합니다. 10피트 정육면체 크기의 물 공이 사거리 내 빈 공간에 나타납니다. 물 공이 처음 나타난 공간이나, 유지 시 이동한 공간에 있는 모든 생물은 기본 반사 내성을 시도해야 합니다. 실패한 생물은 물 공 안에 삼켜져 조이기(grabbed) 상태가 되며, 물 공과 함께 이동합니다. 삼킨 생물은 자신의 턴에 주문 DC에 대해 탈출...",
  ...
  { name_ko: "언데드 속박",
    ...
    duration: "1일",
    summary: "힘의 말로 무심한 언데드를 제어합니다. 대상은 하수인(minion) 특질을 얻고 당신의 명령에 복종합니다. 당신은 각 턴에 행동 1개를 소비하여 대상에게 명령을 내릴 수 있습니다. 대상이 하수인 특질을 가지는 동안, 명령 없이는 자발적으로 행동하지 않습니다. 당신이나 아군이 대상에게 적대 행동을 하면 주문이 즉시 종료됩니다. 주문이 끝나면 대상이 갑자...",
    desc: "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 주문 랭크 이하 레벨의 무심한 언데드 1<br><strong>지속 시간:</strong> 1일<br>힘의 말로 무심한 언데드를 제어합니다. 대상은 <strong>하수인(minion)</strong> 특질을 얻고 당신의 명령에 복종합니다. 당신은 각 턴에 행동 1개를 소비하여 대상에게 명령을 내릴 수 있습니다. 대상이 하수인 특질을 가지는 동안, 명령 없이는 자발적으로 행동하지 않습니다. 당신이나 아군이 대상에게 적대 행동을 하면 주문이 즉시 종료됩니다. 주문이 끝나면 대상이 갑자기 해방되며 적대적이 될 수 있습니다." },
  ...
  { name_ko: "냉기의 어둠",
    ...
    target: "생물 1",
    defense: "AC",
    summary: "불경한 에너지가 스며든 극도로 차가운 어둠의 광선을 발사합니다. 원거리 주문 명중 굴림을 합니다. 광선은 5d6 냉기 피해를 가합니다. 대상이 신성 특질을 지니고 있다면 추가로 5d6 영혼 피해를 가합니다.대성공: 대상이 2배 피해를 받습니다.성공: 대상이 전체 피해를 받습니다.광선이 마법 빛의 영역을 통과하거나 마법 빛의 영향을 받는 생물을 대상으로...",
    desc: "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> AC<br>불경한 에너지가 스며든 극도로 차가운 어둠의 광선을 발사합니다. 원거리 주문 명중 굴림을 합니다. 광선은 <strong>5d6 냉기 피해</strong>를 가합니다. 대상이 신성 특질을 지니고 있다면 추가로 <strong>5d6 영혼 피해</strong>를 가합니다.<br><strong>대성공:</strong> 대상이 2배 피해를 받습니다.<br><strong>성공:</strong> 대상이 전체 피해를 받습니다.<br>광선이 마법 빛의 영역을 통과하거나 마법 빛의 영향을 받는 생물을 대상으로 삼는 경우, 냉기의 어둠은 해당 빛을 상쇄하려 시도합니다. 광선이 빛의 영역을 통과하는지 판단할 필요가 있다면, 자신과 주문의 대상 사이에 선을 그어 확인합니다.<br><strong>강화(+1):</strong> 냉기 피해 +2d6, 신성 생물에 대한 영혼 피해 +2d6." },
  ...
  { name_ko: "유령 무기",
    ...
    target: "비마법 무기 1",
    duration: "10분",
    summary: "무기가 무기에 유령 같은 에너지를 부여하여 무형 생물에 효과적으로 만듭니다. 이 무기로 무형(incorporeal) 생물을 타격하면, 보통은 절반 피해만 주지만 대신 전체 피해를 줍니다. 무형이 아닌 생물에 대해서는 변화가 없습니다.",
    desc: "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 비마법 무기 1<br><strong>지속 시간:</strong> 10분<br>무기가 무기에 유령 같은 에너지를 부여하여 무형 생물에 효과적으로 만듭니다. 이 무기로 무형(incorporeal) 생물을 타격하면, 보통은 절반 피해만 주지만 대신 <strong>전체 피해</strong>를 줍니다. 무형이 아닌 생물에 대해서는 변화가 없습니다." },
  ...
  { name_ko: "신성한 빛",
    ...
    target: "생물 1",
    defense: "AC",
    summary: "신성한 에너지가 깃든 작열하는 빛의 광선을 발사합니다. 원거리 주문 명중 굴림을 합니다. 이 광선은 5d6 화염 피해를 줍니다. 대상이 불경(unholy) 특질을 지니고 있다면, 추가로 5d6 영혼 피해를 줍니다.대성공: 대상이 두 배 피해를 받습니다.성공: 대상이 전체 피해를 받습니다.이 빛이 마법적 어둠 영역을 통과하거나 마법적 어둠의 영향을 받는...",
    desc: "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> AC<br>신성한 에너지가 깃든 작열하는 빛의 광선을 발사합니다. 원거리 주문 명중 굴림을 합니다. 이 광선은 <strong>5d6 화염 피해</strong>를 줍니다. 대상이 불경(unholy) 특질을 지니고 있다면, 추가로 <strong>5d6 영혼 피해</strong>를 줍니다.<br><strong>대성공:</strong> 대상이 두 배 피해를 받습니다.<br><strong>성공:</strong> 대상이 전체 피해를 받습니다.<br>이 빛이 마법적 어둠 영역을 통과하거나 마법적 어둠의 영향을 받는 생물을 대상으로 삼을 경우, 신성한 빛은 그 어둠을 상쇄하려고 시도합니다. 빛이 어둠 영역을 통과하는지 확인해야 한다면, 당신 자신과 주문의 대상 사이에 선을 그어 판단합니다.<br><strong>강화(+1):</strong> 화염 피해가 2d6 증가하고, 불경 생물에 대한 영혼 피해도 2d6 증가합니다." },
  ...
  { name_ko: "최면",
    ...
    defense: "의지",
    duration: "유지(최대 1라운드)",
    summary: "빠르게 변화하는 색채와 무늬의 폭발이 영역 내 생물의 시선을 사로잡습니다. 각 생물은 의지 내성을 시도합니다.대성공: 영향 없음.성공: 눈부심(dazzled) 1라운드.실패: 매혹(fascinated) 상태가 됩니다. 유지하면 매혹이 지속됩니다. 적대 행동을 받으면 매혹 종료.대실패: 매혹 상태 + 멍해짐(stunned) 2.",
  ...
  { name_ko: "마비",
    ...
    defense: "의지",
    duration: "1분",
    summary: "대상의 근육을 마비시켜 제자리에 얼려 붙입니다. 대상은 의지 내성을 시도합니다.대성공: 영향 없음.성공: 1라운드 동안 멍해짐(stunned) 1 상태가 됩니다.실패: 1분 동안 마비(paralyzed) 상태가 됩니다. 대상은 매 턴 끝에 의지 내성을 다시 시도하여 성공하면 마비에서 벗어날 수 있습니다.대실패: 1분 동안 마비 상태가 되며, 턴 끝 내...",
    desc: "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 1분<br>대상의 근육을 마비시켜 제자리에 얼려 붙입니다. 대상은 의지 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> <strong>1라운드</strong> 동안 <strong>멍해짐(stunned) 1</strong> 상태가 됩니다.<br><strong>실패:</strong> <strong>1분</strong> 동안 <strong>마비(paralyzed)</strong> 상태가 됩니다. 대상은 매 턴 끝에 의지 내성을 다시 시도하여 성공하면 마비에서 벗어날 수 있습니다.<br><strong>대실패:</strong> <strong>1분</strong> 동안 <strong>마비</strong> 상태가 되며, 턴 끝 내성으로 벗어날 수 없습니다.<br><strong>강화(7랭크):</strong> 최대 <strong>10</strong>명의 생물을 대상으로 삼을 수 있습니다." },
  ...
  { name_ko: "느리게",
    ...
    defense: "인내",
    duration: "1분",
    summary: "대상의 시간 흐름을 왜곡하여 움직임과 반응을 느리게 합니다. 대상은 인내 내성을 시도합니다.대성공: 영향 없음.성공: 1라운드 동안 느려짐(slowed) 1 상태가 됩니다.실패: 1분 동안 느려짐 1 상태가 됩니다.대실패: 1분 동안 느려짐 2 상태가 됩니다.강화(6랭크): 최대 10명의 생물을 대상으로 삼을 수 있습니다.",
    desc: "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 인내<br><strong>지속 시간:</strong> 1분<br>대상의 시간 흐름을 왜곡하여 움직임과 반응을 느리게 합니다. 대상은 인내 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> <strong>1라운드</strong> 동안 <strong>느려짐(slowed) 1</strong> 상태가 됩니다.<br><strong>실패:</strong> <strong>1분</strong> 동안 <strong>느려짐 1</strong> 상태가 됩니다.<br><strong>대실패:</strong> <strong>1분</strong> 동안 <strong>느려짐 2</strong> 상태가 됩니다.<br><strong>강화(6랭크):</strong> 최대 <strong>10</strong>명의 생물을 대상으로 삼을 수 있습니다." },
  ...
  { name_ko: "화염 방패",
    ...
    traits: ["화염","조작"],
    duration: "1분",
    summary: "방어적인 불꽃의 장막이 당신을 감싸 보호합니다. 주문의 지속 시간 동안 냉기 저항 5를 얻습니다. 인접 생물이 근접 공격으로 당신에게 피해를 줄 때마다, 그 생물은 2d6 화염 피해를 받습니다. 이 반사 피해에는 내성이 없습니다.강화(+2): 냉기 저항 +5, 반사 화염 피해 +1d6.",
    desc: "<strong>지속 시간:</strong> 1분<br>방어적인 불꽃의 장막이 당신을 감싸 보호합니다. 주문의 지속 시간 동안 <strong>냉기 저항 5</strong>를 얻습니다. 인접 생물이 근접 공격으로 당신에게 피해를 줄 때마다, 그 생물은 <strong>2d6 화염 피해</strong>를 받습니다. 이 반사 피해에는 내성이 없습니다.<br><strong>강화(+2):</strong> 냉기 저항 +5, 반사 화염 피해 +1d6." },
  ...
  { name_ko: "깜빡임",
    ...
    traits: ["조작","순간이동"],
    duration: "1분",
    summary: "현재 위치와 에테르 차원 사이를 빠르게 깜빡이며, 시각적으로 불안정하게 명멸합니다. 매 턴 시작 시 DC 11 단순 판정을 합니다. 성공하면 해당 턴 동안 은폐(concealed) 상태가 됩니다. 공격자가 당신을 타격하려면 DC 5 단순 판정에 성공해야 하며, 실패하면 공격이 빗나갑니다. 단순 판정에 실패하면 해당 턴에는 정상적으로 보입니다.강화(8랭...",
    desc: "<strong>지속 시간:</strong> 1분<br>현재 위치와 에테르 차원 사이를 빠르게 깜빡이며, 시각적으로 불안정하게 명멸합니다. 매 턴 시작 시 <strong>DC 11 단순 판정</strong>을 합니다. 성공하면 해당 턴 동안 <strong>은폐(concealed)</strong> 상태가 됩니다. 공격자가 당신을 타격하려면 DC 5 단순 판정에 성공해야 하며, 실패하면 공격이 빗나갑니다. 단순 판정에 실패하면 해당 턴에는 정상적으로 보입니다.<br><strong>강화(8랭크):</strong> 단순 판정 DC가 <strong>6</strong>으로 줄어듭니다. 또한, 깜빡일 때 현재 위치에서 최대 <strong>10피트</strong>까지 순간이동할 수 있습니다." },
  ...
  { name_ko: "신기루",
    ...
    desc: "<strong>사거리:</strong> 500피트<br><strong>영역:</strong> 50피트 폭발<br><strong>지속 시간:</strong> 다음 일일 준비까지<br>자연 환경 하나를 다른 것으로 위장합니다. 숲을 사막으로, 들판을 늪으로 등. 환경의 물리적 특성은 변하지 않지만 외관이 변합니다. 지각 판정으로 불신 가능.<br><strong>강화(5랭크):</strong> 영역 1마일 폭발." },
  ...
  { name_ko: "산의 강인함",
    ...
    target: "생물 1",
    duration: "1분",
    summary: "대상의 피부를 돌처럼 단단하게 만들어 물리적 공격으로부터 보호합니다. 대상은 주문의 지속 시간 동안 물리 피해에 대한 저항 5를 얻습니다. 이 저항은 타격, 관통, 참격 피해에 모두 적용됩니다.강화(6랭크): 저항이 10으로 증가합니다.강화(8랭크): 저항이 15로 증가합니다.",
    desc: "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 1분<br>대상의 피부를 돌처럼 단단하게 만들어 물리적 공격으로부터 보호합니다. 대상은 주문의 지속 시간 동안 <strong>물리 피해에 대한 저항 5</strong>를 얻습니다. 이 저항은 타격, 관통, 참격 피해에 모두 적용됩니다.<br><strong>강화(6랭크):</strong> 저항이 <strong>10</strong>으로 증가합니다.<br><strong>강화(8랭크):</strong> 저항이 <strong>15</strong>로 증가합니다." },
  ...
  { name_ko: "악몽",
    ...
    target: "알고 있는 생물 1",
    defense: "의지",
    summary: "생물의 꿈을 끔찍한 악몽으로 물들입니다. 대상이 잠들면 공포스러운 악몽을 경험합니다. 대상은 의지 내성을 시도합니다.대성공: 영향 없음. 이 시전에 대해 면역이 됩니다.성공: 대상이 불안한 꿈을 꾸지만, 깨어난 후 경미한 불편만 남습니다.실패: 대상이 끔찍한 악몽을 꾸고 피로(fatigued) 상태로 깨어나며, 4d6 정신 피해를 받습니다.대실패: 실...",
    desc: "<strong>사거리:</strong> 행성 전체<br><strong>대상:</strong> 알고 있는 생물 1<br><strong>방어:</strong> 의지<br>생물의 꿈을 끔찍한 악몽으로 물들입니다. 대상이 잠들면 공포스러운 악몽을 경험합니다. 대상은 의지 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음. 이 시전에 대해 면역이 됩니다.<br><strong>성공:</strong> 대상이 불안한 꿈을 꾸지만, 깨어난 후 경미한 불편만 남습니다.<br><strong>실패:</strong> 대상이 끔찍한 악몽을 꾸고 <strong>피로(fatigued)</strong> 상태로 깨어나며, <strong>4d6 정신 피해</strong>를 받습니다.<br><strong>대실패:</strong> 실패와 같지만, <strong>2배 피해</strong>를 받습니다." },
  ...
  { name_ko: "자유 이동",
    ...
    target: "생물 1",
    duration: "10분",
    summary: "대상의 움직임을 방해하는 모든 제약에서 해방시킵니다. 대상은 조이기(grabbed), 이동 불가(immobilized), 억제(restrained) 상태를 무시하며, 이러한 상태를 부여하려는 새로운 시도에도 면역이 됩니다. 또한 험지(difficult terrain)를 정상 지형으로 취급하여 자유롭게 이동할 수 있습니다.",
    desc: "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 10분<br>대상의 움직임을 방해하는 모든 제약에서 해방시킵니다. 대상은 <strong>조이기(grabbed)</strong>, <strong>이동 불가(immobilized)</strong>, <strong>억제(restrained)</strong> 상태를 무시하며, 이러한 상태를 부여하려는 새로운 시도에도 면역이 됩니다. 또한 <strong>험지(difficult terrain)</strong>를 정상 지형으로 취급하여 자유롭게 이동할 수 있습니다." },
  ...
  { name_ko: "추방",
    ...
    defense: "의지",
    summary: "대상을 고향 차원으로 추방하려 시도합니다. 당신은 자신의 고향 차원에서 이 주문을 시전해야 합니다. 주문 시전 시 추가 행동(물질 구성요소)을 사용하고 대상의 고향 차원에 대한 혐오 물질을 비용으로 지불하면, 대상의 의지 내성에 -2 상황 페널티를 줄 수 있습니다. 대상은 의지 내성을 시도합니다.대성공: 대상이 추방에 저항하고, 시전자가 멍해짐 1이 ...",
  ...
  { name_ko: "생명의 숨결",
    ...
    summary: "사망의 문턱에 있는 생물에게 활력 에너지를 불어넣어 죽음에서 되돌립니다. 유발 생물은 6d8 HP를 회복합니다. 회복 후 HP가 1 이상이 되면 생물의 사망이 방지됩니다. HP가 여전히 0 이하이면 사망은 그대로 진행됩니다. 이 주문에 의해 사망이 방지된 생물은 빈사(dying) 상태를 잃습니다.",
    desc: "<strong>사거리:</strong> 60피트<br><strong>대상:</strong> 유발 생물<br><strong>유발 조건:</strong> 사거리 내 생물이 사망<br>사망의 문턱에 있는 생물에게 활력 에너지를 불어넣어 죽음에서 되돌립니다. 유발 생물은 <strong>6d8 HP</strong>를 회복합니다. 회복 후 HP가 1 이상이 되면 생물의 사망이 방지됩니다. HP가 여전히 0 이하이면 사망은 그대로 진행됩니다. 이 주문에 의해 사망이 방지된 생물은 <strong>빈사(dying) 상태를 잃습니다</strong>." },
  ...
  { name_ko: "영적 수호자",
    ...
    desc: "<strong>사거리:</strong> 120피트<br><strong>지속 시간:</strong> 유지(최대 1분)<br>마법의 힘으로 만들어진 중형 수호자가 범위 내 빈 공간에 출현합니다. 수호자는 반투명하며 착용하거나 든 무기 중 하나의 유령 같은 복제본을 지닙니다. 신을 섬기는 경우 수호자는 신의 시종 또는 봉사자 형태를 취합니다. 주문을 성별화하면 수호자의 공격도 성별화됩니다. 생물은 수호자의 공간을 통과할 수 있지만 그 안에 멈출 수 없습니다. 수호자와 협공이 가능합니다. 수호자는 HP 50 외 다른 속성이 없으며 HP는 회복이 불가능하고 아래의 보호 행동을 할 때만 HP를 잃습니다. 주문 시전 시 및 유지 시마다 수호자를 120피트 내 빈 공간으로 이동시키고 다음 중 하나를 수행합니다:<br><strong>공격:</strong> 수호자가 인접한 생물에 근접 주문 명중 굴림을 실행합니다. 명중 시 <strong>3d8 피해</strong>(급소 공격 시 2배). 피해 유형은 무기 유형과 같으며, 영혼 피해가 더 해로우면 영혼 피해로. 다중 공격 페널티에 기여합니다.<br><strong>보호:</strong> 인접한 선택한 생물을 보호합니다. 그 생물이 피해를 받을 때마다 수호자가 대신 피해를 받습니다. 수호자의 HP가 0이 되면 사라지고 주문이 종료됩니다." },
  ...
  { name_ko: "석화",
    ...
    target: "생물 1",
    defense: "인내",
    summary: "대상의 몸이 점점 돌로 변해갑니다. 대상은 인내 내성을 시도합니다.대성공: 영향 없음.성공: 1라운드 동안 느려짐(slowed) 1 상태가 됩니다.실패: 1분 동안 느려짐 1 상태가 됩니다. 매 턴 끝에 인내 내성을 다시 시도합니다. 성공하면 주문이 종료되지만, 실패하면 영구적으로 석화(petrified) 상태가 됩니다.대실패: 대상이 즉시 영구적으로...",
    desc: "<strong>사거리:</strong> 120피트<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 인내<br>대상의 몸이 점점 돌로 변해갑니다. 대상은 인내 내성을 시도합니다.<br><strong>대성공:</strong> 영향 없음.<br><strong>성공:</strong> <strong>1라운드</strong> 동안 <strong>느려짐(slowed) 1</strong> 상태가 됩니다.<br><strong>실패:</strong> <strong>1분</strong> 동안 <strong>느려짐 1</strong> 상태가 됩니다. 매 턴 끝에 인내 내성을 다시 시도합니다. 성공하면 주문이 종료되지만, 실패하면 <strong>영구적으로 석화(petrified)</strong> 상태가 됩니다.<br><strong>대실패:</strong> 대상이 <strong>즉시 영구적으로 석화</strong> 상태가 됩니다." },
  ...
  { name_ko: "정밀 대상",
    ...
    desc: "<strong>사거리:</strong> 60피트<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 다음 일일 준비까지<br>한 생물에 대한 여러 공격을 특별히 정확하게 합니다. 이 턴과 다음 턴에 대상에 대한 명중 굴림에서 <strong>d20을 두 번 굴려 높은 것을 사용</strong>." },
  ...
  { name_ko: "탈수",
    ...
    target: "살아있는 생물 다수",
    defense: "기본 인내",
    summary: "살아있는 생물의 몸에서 수분을 격렬하게 빼앗습니다. 대상은 10d10 공허 피해를 받고 기본 인내 내성을 시도합니다. 물(water) 특질이나 식물(plant) 특질을 가진 생물은 내성 결과가 한 단계 나빠집니다. 수분이 없는 생물(대지 정령 등)은 이 주문에 면역입니다.강화(+1): 피해 +1d10.",
    desc: "<strong>사거리:</strong> 500피트<br><strong>대상:</strong> 살아있는 생물 다수<br><strong>방어:</strong> 기본 인내<br>살아있는 생물의 몸에서 수분을 격렬하게 빼앗습니다. 대상은 <strong>10d10 공허 피해</strong>를 받고 <strong>기본 인내 내성</strong>을 시도합니다. 물(water) 특질이나 식물(plant) 특질을 가진 생물은 내성 결과가 <strong>한 단계 나빠집니다</strong>. 수분이 없는 생물(대지 정령 등)은 이 주문에 <strong>면역</strong>입니다.<br><strong>강화(+1):</strong> 피해 +1d10." },
  ...
  { name_ko: "억제할 수 없는 춤",
    ...
    desc: "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>방어:</strong> 의지<br><strong>지속 시간:</strong> 다양<br>춤에 대한 억제할 수 없는 충동으로 대상을 극복합니다. 의지 실패 시 대상이 매 턴 1행동을 춤추는 데 사용해야 합니다(무방비+이동 속도 -10피트). 대실패 시 모든 행동을 춤에 사용." },
  ...
  { name_ko: "예지",
    ...
    target: "생물 1",
    duration: "1시간",
    summary: "위험 감각이 생물에게 위험을 경고하고 행운으로 보호합니다. 대상은 무방비(off-guard)이 되지 않으며, 선제력(initiative) 굴림과 지각 판정에 +2 상태 보너스. 위험이 임박하면 시전자에게도 경고합니다. 또한 턴 시작 시 반응으로 대상이나 시전자가 다음 내성이나 AC에 +2 상황 보너스를 사용할 수 있습니다.",
    desc: "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 1시간<br>위험 감각이 생물에게 위험을 경고하고 행운으로 보호합니다. 대상은 <strong>무방비(off-guard)이 되지 않으며</strong>, 선제력(initiative) 굴림과 지각 판정에 <strong>+2 상태 보너스</strong>. 위험이 임박하면 시전자에게도 경고합니다. 또한 턴 시작 시 반응으로 대상이나 시전자가 <strong>다음 내성이나 AC에 +2 상황 보너스</strong>를 사용할 수 있습니다." },
