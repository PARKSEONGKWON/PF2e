...
const SPELL_DB = [
  ...
  { name_ko: "야생 해방",
    ...
    desc: "<strong>지속 시간:</strong> 1라운드<br>자신의 내면에서 다른 부분을 찾아 해방시켜 몸을 다른 형태로 변화시킵니다. <em>해충 형태(pest form)</em>에 나열된 어떤 형태로든 변이할 수 있으며, 이 형태는 10분 동안 지속됩니다. 그 외의 야생 해방 형태는 1분 동안 지속됩니다. 드루이드 재주를 통해 야생 해방 목록에 더 많은 형태를 추가할 수 있습니다. 사용 가능한 재주에 따라 접근할 수 있는 형태가 결정됩니다." },
  ...
  { name_ko: "자신감의 장막",
    ...
    desc: "<strong>지속 시간:</strong> 1분<br>자신감으로 자신을 감쌉니다. 현재 공포(frightened) 수치를 <strong>1 감소</strong>시키고, 지속 시간 동안 공포 상태가 될 때마다 그 수치를 <strong>1 감소</strong>시킵니다. 공포 효과에 대해 대실패를 하면, 자신감의 장막이 해당 효과의 공포 수치를 줄인 후 주문이 종료됩니다." },
  ...
  { name_ko: "자유의 말씀",
    ...
    range: "30피트",
    target: "생물 1",
    summary: "생물을 해방하는 자유의 말을 내뱉습니다. 다음 상태 중 하나를 선택하여 억제합니다: 혼란, 공포, 조이기, 마비, 억제. 대상은 선택한 상태의 영향을 받지 않으며, 조이기나 억제를 억제하면 주문 시전 시 자동으로 해방됩니다.상태를 제공한 효과 자체를 제거하지 않으면, 주문이 끝난 후 상태가 돌아옵니다. 예를 들어, 혼란을 1분간 주는 주문이 있다면, ...",
    desc: "<strong>사거리:</strong> 30피트<br><strong>대상:</strong> 생물 1<br>생물을 해방하는 자유의 말을 내뱉습니다. 다음 상태 중 하나를 선택하여 억제합니다: 혼란, 공포, 조이기, 마비, 억제. 대상은 선택한 상태의 영향을 받지 않으며, 조이기나 억제를 억제하면 주문 시전 시 자동으로 해방됩니다.<br>상태를 제공한 효과 자체를 제거하지 않으면, 주문이 끝난 후 상태가 돌아옵니다. 예를 들어, 혼란을 1분간 주는 주문이 있다면, 자유의 말씀은 1라운드 동안 대상이 정상적으로 행동하게 하지만, 혼란 상태는 이후에 돌아옵니다." },
