...
const SPELL_DB = [
  ...
  { name_ko: "개미 운반",
    ...
    desc: "<strong>사거리:</strong> 접촉<br><strong>대상:</strong> 생물 1<br><strong>지속 시간:</strong> 8시간<br>대상의 근골격계를 강화하여 더 많은 무게를 견딜 수 있게 합니다. 대상은 과적(encumbered) 상태가 되기 전에 <strong>3 부피</strong>를 추가로 운반할 수 있으며, 최대 <strong>6 부피</strong>까지 추가로 운반할 수 있습니다." },
  ...
  { name_ko: "축복",
    ...
    desc: "<strong>영역:</strong> 10피트 발산<br><strong>지속 시간:</strong> 1분<br>아군의 공격을 영역 내에서 강화합니다. 영역 내의 당신을 포함한 아군은 영역에 있는 한 명중 굴림에 <strong>+1 상태 보너스</strong>를 얻습니다. 이후 매 턴 한 번 주문을 유지하여 발산 반경을 <strong>10피트</strong>씩 증가시킬 수 있습니다. <em>축복(bless)</em>은 <em>재앙(bane)</em>을 상쇄할 수 있습니다." },
