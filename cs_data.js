...
const HERITAGE_DB = [
  ...
  {id:'wellspring-gnome',name_ko:'원천 노움',name_en:'Wellspring Gnome',ancestry:'gnome',summary:'다른 마법 원천이 페이 혈통의 근원 마법보다 당신을 더 강하게 붙잡고 있습니다. 이 연결은 비학 차원이나 고대 비학 노래, 신격/천상체/악마, 마법사 전쟁이 남긴 마법 유출물, 또는 고대 룬 마법에서 올 수 있습니다. 비전, 신성, 비학 중 하나를 선택합니다. 해당 마법 전통의 주문 목록에서 캔트립 1개를 얻습니다. 이 주문을 선택한 전통의 선천 주문으로 자유롭게 시전할 수 있습니다. 캔트립은 레벨 절반(올림)과 같은 주문 랭크로 고양됩니다. 노움 혈통 특기에서 근원 선천 주문을 얻을 때마다, 그 전통을 근원에서 선택한 전통으로 변경합니다.'},
  // 고블린
