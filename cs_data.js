...
const SUBCLASS_DB = [
  ...
  {id:'racket-mastermind',       class_id:'rogue', subclass_type:'전문', name_ko:'지략가',      name_en:'Mastermind',
   summary:'지능에 의지하여 정교한 계략을 세우며, 다른 이가 3수 앞을 볼 때 10수 앞을 봅니다. 지식 회상으로 생물을 성공적으로 식별하면 다음 턴 시작까지 당신의 공격에 <strong>무방비</strong>; 대성공이면 1분간.<br><strong>기술:</strong> 사회 + 신비학/자연학/비학/종교 중 1개. <strong>핵심 속성:</strong> 지능 선택 가능.'},
