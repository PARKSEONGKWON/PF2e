...
const CLASSES = [
  ...
  {id:'witch', name:'위치', en:'Witch', hp:6,
   ...
   skills:'오컬티즘 + 3+INT개'},
  {id:'wizard', name:'위저드', en:'Wizard', hp:6,
...
const SUBCLASS_DB = [
  ...
  {id:'racket-mastermind',       class_id:'rogue', subclass_type:'전문', name_ko:'지략가',      name_en:'Mastermind',
   summary:'지능에 의지하여 정교한 계략을 세우며, 다른 이가 3수 앞을 볼 때 10수 앞을 봅니다. 지식 회상으로 생물을 성공적으로 식별하면 다음 턴 시작까지 당신의 공격에 <strong>무방비</strong>; 대성공이면 1분간.<br><strong>기술:</strong> 사회 + 주문학/자연학/비학/종교 중 1개. <strong>핵심 속성:</strong> 지능 선택 가능.'},
...
const BACKGROUNDS = [
  ...
  {id:'cultist', name:'이교도', en:'Cultist', boosts:'지능 또는 매력, 자유', skills:'오컬티즘, 신격/교단 지식', feat:'비밀 교육', desc:'풍성한 수확을 위한 신성한 춤이나 어둠의 힘을 부르는 끔찍한 의식을 행하는 교단의 (전/현) 구성원입니다. 속성 부스트: 지능 또는 매력, 자유 | 기술: 비학, 신격/교단 관련 지식 | 기술 재주: 비밀 교육'},
  ...
  {id:'fortune-teller', name:'점술사', en:'Fortune Teller', boosts:'지능 또는 매력, 자유', skills:'오컬티즘, 점술 지식', feat:'기이한 것 식별', desc:'운명의 실이 분명하며, 평민이 미래를 점칠 수 있는 많은 전통적 방법을 배웠습니다. 속성 부스트: 지능 또는 매력, 자유 | 기술: 비학, 점술 지식 | 기술 재주: 기이한 것 식별'},
  ...
  {id:'hermit', name:'은둔자', en:'Hermit', boosts:'건강 또는 지능, 자유', skills:'자연학 또는 오컬티즘, 지형 지식', feat:'의심스러운 지식', desc:'동굴, 외딴 오아시스, 격리된 저택 같은 곳에서 고독한 삶을 살았습니다. 속성 부스트: 건강 또는 지능, 자유 | 기술: 자연학 또는 비학, 지형 지식 | 기술 재주: 의심스러운 지식'},
  ...
  {id:'scholar', name:'학자', en:'Scholar', boosts:'지능 또는 지혜, 자유', skills:'주문학/자연학/오컬티즘/종교학 중 선택, 학술원 지식', feat:'확인', desc:'배우는 재능이 있어 바깥 세계에서 격리되어 할 수 있는 모든 것을 배웠습니다. 책에서 많은 경이로운 장소와 사물을 읽었고, 결국 호기심이 모험가가 되게 했습니다. 속성 부스트: 지능 또는 지혜, 자유 | 기술: 주문학/자연학/비학/종교 중 선택, 학술원 지식 | 기술 재주: 선택한 기술의 확인'},
...
const HERITAGE_DB = [
  ...
  {id:'wellspring-gnome',name_ko:'원천 노움',name_en:'Wellspring Gnome',ancestry:'gnome',innateSpells:[{name:'선택한 전통 캔트립 1개',tradition:'선택',type:'cantrip',uses:'자유'}],summary:'다른 마법 원천이 페이 혈통의 원시 마법보다 당신을 더 강하게 붙잡고 있습니다. 이 연결은 비학 차원이나 고대 비학 노래, 신격/천상체/악마, 마법사 전쟁이 남긴 마법 유출물, 또는 고대 룬 마법에서 올 수 있습니다. 비전, 신성, 비학 중 하나를 선택합니다. 해당 마법 전통의 주문 목록에서 캔트립 1개를 얻습니다. 이 주문을 선택한 전통의 선천 주문으로 자유롭게 시전할 수 있습니다. 캔트립은 레벨 절반(올림)과 같은 주문 랭크로 고양됩니다. 노움 혈통 재주에서 원시 선천 주문을 얻을 때마다, 그 전통을 원시에서 선택한 전통으로 변경합니다.'},
  // 고블린
...
const TRAIT_DB = {
  ...
  '힘':'힘(Force) 에너지.',
  '일반':'클래스 무관 선택 가능한 재주.',
  '기술':'특정 분야의 훈련과 능력을 나타내는 17개 기술(곡예~도둑질).',
  '원형':'다중 클래스 전용 재주.',
  '일반 기술':'일반 기술 재주.',
  ...
  '바드':'장식 가죽, 대거, 레이피어, 투석구+탄 20발, 모험가 팩, 휴대용 악기7gp 4sp 8cp',
  '클레릭':'탐험가 의복, 모험가 팩, 나무 종교 상징13gp 3sp',
  '드루이드':'수피 갑옷, 자벨린 4개, 창, 모험가 팩, 근원 상징11gp',
  '파이터':'수피 갑옷, 대거, 모험가 팩11gp',
  '레인저':'가죽 갑옷, 대거, 모험가 팩11gp 3sp',
  '로그':'가죽 갑옷, 대거, 레이피어, 모험가 팩, 등반 키트8gp 8sp',
  '위치':'탐험가 의복, 낫, 투석구+탄 20발, 지팡이, 모험가 팩13gp 1sp 8cp',
  '위저드':'탐험가 의복, 지팡이, 비전 주머니, 모험가 팩13gp 1sp 8cp',
  ...
  '뱀':'송곳니 1d8 관통독 지원, 조이기',
  '늑대':'턱 1d8 관통넘어뜨리기 지원',
  '공룡 (드로메오사우루스)':'턱 1d8 관통, 발톱 1d6 참격민첩, 도약 공격',
  '바드 헌신':'비학 주문시전(캔트립 2개 + 레퍼토리), 뮤즈 선택',
  '클레릭 헌신':'신성 주문시전(캔트립), 신격 선택, 신성 글꼴',
  ...
  '운동 <span class="en">Athletics</span>':'등반, 억지로 열기, 조이기, 높이뛰기, 멀리뛰기, 재배치, 밀기, 수영, 넘어뜨리기무장 해제',
  ...
  '비학 <span class="en">Occultism</span>':'지식 회상문서 해독, 마법 식별, 주문 학습',
  ...
  '속성 부스트':'속성 수정치를 1만큼 증가. +4 이상이면 2회 부스트 필요(부분 부스트). 동시에 여러 부스트를 받으면 각각 다른 속성에 적용.',
  '속성 결함':'속성 수정치를 1만큼 감소.',
  '속성 수정치':'6개 수정치: 근력(Str), 민첩(Dex), 건강(Con), 지능(Int), 지혜(Wis), 매력(Cha). 판정과 다른 능력치에 영향.',
  '오라':'지속적으로 주변에 영향을 미치는 발산 효과.',
  '배경':'모험가가 되기 전의 경험. 캐릭터 생성 시 선택. 속성 부스트, 기술 훈련, 기술 재주 제공.',
  '기본 행동':'모든 생물이 사용할 수 있는 행동(보폭, 타격, 상호작용 등).',
  '출혈':'지속 피해의 한 유형. 턴 종료 시 피해를 받고 DC 15 단순 판정으로 종료 가능.',
  '보너스':'판정에 추가하는 양수 값. 같은 유형(상황/아이템/상태)은 가장 높은 것만 적용.',
  '밝은 빛':'정상적으로 볼 수 있는 조명.',
  '파손':'아이템의 HP가 파손 기준(BT) 이하가 되면 사용 불가. 수리 필요.',
  '부피':'아이템의 크기, 무게, 운반 난이도. L(경량)은 10개=1 부피. 5+근력 수정치 초과 시 과적.',
  '폭발':'원점에서 지정 반경의 구형 영역.',
  '캠페인':'한 파티를 중심으로 여러 모험에 걸쳐 진행되는 연재 이야기.',
  '판정':'d20을 굴리고 수정치/보너스/페널티를 더하여 DC와 비교하는 행위.',
  '상황 보너스':'상황에서 비롯되는 보너스(예: 엄폐, 방패 올리기).',
  '상황 페널티':'상황에서 비롯되는 페널티.',
  '클래스':'캐릭터가 선택하는 모험 직업. 핵심 속성, 특성, 재주를 제공.',
  '클래스 DC':'클래스가 부여하는 일부 능력의 난이도. 10 + 숙련 보너스 + 핵심 속성 수정치.',
  '상태':'캐릭터의 행동이나 능력치를 변경하는 지속적 효과(공포, 빈사 등).',
  '원뿔':'시전자에서 시작하는 삼각형 영역.',
  '상쇄':'마법 효과를 제거하는 판정. d20+속성 수정치+숙련 보너스 vs 효과 DC.',
  '생물':'이야기와 세계의 능동적 참가자. 몬스터, NPC, PC 포함.',
  '치명타':'명중 굴림의 대성공. 피해 2배.',
  '대실패':'DC보다 10 이상 낮은 결과. 또는 자연 1로 악화.',
  '대성공':'DC를 10 이상 초과한 결과. 또는 자연 20으로 향상.',
  '일일 준비':'아침에 장비 정리, 주문 준비, 모험 준비를 하는 시간.',
  '피해':'생물의 HP를 감소시키는 것. 근접 피해 = 무기 피해 주사위 + 근력 수정치 + 보너스/페널티.',
  '피해 유형':'물리(둔기/관통/참격), 에너지(산성/냉기/전기/화염/음파), 정렬(신성/불경), 정신, 독, 활력, 공허, 영혼, 힘, 출혈, 정밀.',
  'DC':'판정이 성공하기 위해 달성해야 하는 숫자.',
  '빈사':'생과 사의 경계. 매 턴 회복 판정(DC 10+빈사 수치). 빈사 4 도달 시 사망.',
  '발산':'원점을 중심으로 퍼지는 영역(원점 자체는 포함되지 않을 수 있음).',
  '조우':'전투나 위험 상황. 선제력 굴림으로 시작, 라운드 단위로 진행.',
  '재주':'캐릭터가 배우는 특수 능력. 혈통, 클래스, 일반, 기술 재주가 있음.',
  '단순 판정':'수정치 없이 d20만 굴리는 판정. 지정 DC 이상이면 성공.',
  '집중점':'집중 주문을 시전하기 위해 소비하는 점수. 재집중으로 회복.',
  '집중 주문':'집중점으로 시전하는 특수 주문. 자동으로 레벨 절반(올림) 강화.',
  'GM':'세계, NPC, 이야기를 관리하고 규칙을 중재하는 플레이어.',
  '유산':'혈통 내 하위 그룹. 1레벨에 선택, 고유 능력 제공.',
  '영웅 점수':'영웅적 행동에 대한 보상. 다시 굴림(1점) 또는 빈사 회복(전부 소비).',
  '히트 포인트(HP)':'생물이 의식을 잃기 전에 받을 수 있는 피해량. 0 HP에서 빈사/무의식.',
  '선제력':'조우 시작 시 행동 순서를 결정하는 굴림(보통 감지 또는 은신).',
  '선천 주문':'혈통이나 아이템에서 자연스럽게 오는 주문. 슬롯 불필요.',
  '아이템 보너스':'아이템에서 비롯되는 보너스.',
  '아이템 레벨':'아이템의 복잡성과 마법 수준. 제작 시 자신의 레벨 이하만 가능.',
  '직선':'시전자에서 시작하는 5피트 폭의 직선 영역.',
  ...
  '다중 공격 페널티':'같은 턴 2번째 공격 -5, 3번째+ -10. 민첩 무기는 -4/-8. 턴 끝에 초기화.',
  'NPC':'GM이 조종하는 캐릭터.',
  'PC':'플레이어가 조종하는 캐릭터.',
  '페널티':'판정에서 빼는 음수 값. 유형 없는 페널티는 모두 누적.',
  '감지':'환경 인식 능력. 지혜 수정치 사용. 선제력, 탐색에 사용.',
  '지속 피해':'턴 종료 시 자동 피해. DC 15 단순 판정으로 종료.',
  '숙련도':'미숙련(+0), 숙련(레벨+2), 전문가(+4), 달인(+6), 전설(+8).',
  '반응':'특정 유발 조건에 반응하여 사용하는 행동. 턴당 1회.',
  '라운드':'모든 참가자가 한 번씩 턴을 가지는 시간 단위(약 6초).',
  '내성 굴림':'위험한 효과를 피하기 위한 반응형 판정. 인내(건강), 반사(민첩), 의지(지혜).',
  '비밀 판정':'GM이 대신 굴리는 판정. 플레이어는 결과를 직접 알지 못함.',
  '주문':'마법 효과. 주문 슬롯, 집중점, 또는 선천적으로 시전. 1~10랭크.',
  '주문 공격':'주문으로 하는 명중 굴림. 대상의 AC에 대해 판정.',
  '주문 DC':'주문 효과에 대한 내성 DC. 10 + 속성 수정치 + 숙련 보너스.',
  '주문 슬롯':'하루에 시전할 수 있는 주문의 수를 나타내는 자원.',
  '상태 보너스':'주문이나 마법 효과에서 비롯되는 보너스.',
  '상태 페널티':'해로운 상태에서 비롯되는 페널티.',
  '보폭':'[1행동] 이동 속도까지 이동.',
  '타격':'[1행동] 무기나 비무장으로 공격.',
  '턴':'한 생물이 행동하는 시간. 보통 3행동+1반응.',
  '비일반':'특별한 접근이나 GM 허가가 필요한 아이템/주문/재주.',
  '비무장 공격':'무기 없이 하는 공격(주먹 등). 1d4 B, 민첩, 기교, 비치명.',
  '경험치(XP)':'캐릭터 진보를 추적. 1,000 XP마다 레벨업.',
  '혈통':'캐릭터가 속하는 종족. HP, 크기, 이동 속도, 속성 부스트/결함, 유산, 혈통 재주 제공.',
  '갑옷 등급(AC)':'공격에 대한 방어력. AC = 10 + 민첩 수정치(민첩 상한까지) + 숙련 보너스 + 갑옷 아이템 보너스.',
  '명중 굴림':'d20 + 속성 수정치(근력/민첩) + 숙련 보너스 + 기타. 대상의 AC에 대해 비교.',
  '암시야':'어둠에서도 밝은 빛처럼(흑백으로) 볼 수 있는 감각.',
  '저광 시야':'희미한 빛에서 밝은 빛처럼 볼 수 있는 감각.',
  '인내(내성)':'건강 수정치 기반 내성 굴림. 독, 질병, 신체 효과 저항.',
  '반사(내성)':'민첩 수정치 기반 내성 굴림. 피할 수 있는 효과 회피.',
  '의지(내성)':'지혜 수정치 기반 내성 굴림. 정신 효과 저항.',
  '이동 속도':'보폭(Stride) 등 이동 행동에 사용 가능한 거리(피트 단위).',
  '저항':'특정 피해 유형의 피해를 저항 수치만큼 감소.',
  '약점':'특정 피해 유형의 피해를 약점 수치만큼 증가.',
  '임시 히트 포인트':'일반 HP와 별도. 피해를 먼저 흡수. 보통 누적 불가. 치유로 회복 불가.',
  '엄폐':'장벽 뒤에서 방어 향상. 하위(+1 AC), 표준(+2 AC/반사/은신), 상위(+4).',
  '협공':'적의 반대편에 아군과 함께 있으면 대상이 무방비(off-guard, AC -2).',
  '험지':'5피트 이동에 추가 5피트 비용. 극심 험지는 추가 10피트.',
  '휴식':'장기 활동을 위한 플레이 모드. 돈 벌기, 제작, 재훈련 등.',
