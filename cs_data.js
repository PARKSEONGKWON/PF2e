...
const SUBCLASS_DB = [
  ...
  {id:'racket-mastermind',       class_id:'rogue', subclass_type:'전문', name_ko:'지략가',      name_en:'Mastermind',
   summary:'지능에 의지하여 정교한 계략을 세우며, 다른 이가 3수 앞을 볼 때 10수 앞을 봅니다. 지식 회상으로 생물을 성공적으로 식별하면 다음 턴 시작까지 당신의 공격에 <strong>방심</strong>; 대성공이면 1분간.<br><strong>기술:</strong> 사회 + 신비학/자연학/비학/종교 중 1개. <strong>핵심 속성:</strong> 지능 선택 가능.'},
  {id:'racket-scoundrel',        class_id:'rogue', subclass_type:'전문', name_ko:'사기꾼',      name_en:'Scoundrel',
   summary:'재빠른 말솜씨, 아첨, 날카로운 혀로 위험을 피하고 곤란한 상황을 탈출합니다. 기만으로 성공적으로 속임(Feint) 시 다음 턴 종료까지 당신의 근접 공격에 <strong>방심</strong>; 대성공이면 모든 근접 공격에. 민첩/기교 근접 무기를 들고 속이면 즉시 <strong>자유 행동으로 한 걸음</strong>.<br><strong>기술:</strong> 기만, 외교. <strong>핵심 속성:</strong> 매력 선택 가능.'},
  {id:'racket-ruffian',          class_id:'rogue', subclass_type:'전문', name_ko:'건달',        name_en:'Ruffian',
   summary:'직접적 접근을 선호: 완력이나 위협. 어떤 무기로든 은밀 공격 피해를 줄 수 있습니다(단, d8 초과 단순 무기나 d6 초과 군용/고급 무기는 제외). 이 무기로 방심한 대상에 치명타 시 <strong>치명 특성 효과</strong> 적용.<br><strong>기술:</strong> 위협, 평갑 숙련. <strong>핵심 속성:</strong> 근력 선택 가능. 경갑 전문가/달인 획득 시 평갑에도 적용.'},
...
const BACKGROUNDS = [
  ...
  {id:'raised-by-belief', name:'신앙에 의해 양육됨', en:'Raised by Belief', boosts:'신격 속성 중 하나, 자유', skills:'신격 기술, 신격 지식', feat:'확인', desc:'수도원, 종교적 가정, 또는 일상생활의 일부로, 특정 신격의 전통에 깊이 젖은 양육을 받았습니다. 속성 부스트: 신격의 신성 속성 중 하나, 자유 | 기술: 신격의 신성 기술, 신격 관련 지식 | 기술 특기: 해당 기술의 확인'},
  ...
  {id:'scholar', name:'학자', en:'Scholar', boosts:'지능 또는 지혜, 자유', skills:'신비학/자연학/오컬티즘/종교학 중 선택, 학술원 지식', feat:'확인', desc:'배우는 재능이 있어 바깥 세계에서 격리되어 할 수 있는 모든 것을 배웠습니다. 책에서 많은 경이로운 장소와 사물을 읽었고, 결국 호기심이 모험가가 되게 했습니다. 속성 부스트: 지능 또는 지혜, 자유 | 기술: 신비학/자연학/비학/종교 중 선택, 학술원 지식 | 기술 특기: 선택한 기술의 확인'},
...
const HERITAGE_DB = [
  ...
  {id:'battle-ready-orc',name_ko:'전투 준비 오크',name_en:'Battle-Ready Orc',ancestry:'orc',summary:'두려운 전장 지휘관의 혈통입니다. <strong>위협(Intimidation)에 숙련</strong>되고, <strong>위협적 노려보기(Intimidating Glare)</strong> 기술 재주를 얻습니다.'},
  {id:'deep-orc',name_ko:'심연 오크',name_en:'Deep Orc',ancestry:'orc',summary:'굳은살이 박힌 손과 빨간 눈이 산악 동굴의 깊은 어둠에서 보낸 삶을 말해줍니다. 지하 지형에 대한 <strong>지형 전문가(Terrain Expertise)</strong> 기술 재주와 <strong>전투 등반가(Combat Climber)</strong> 기술 재주를 얻습니다.'},
  {id:'hold-scarred-orc',name_ko:'흉터 오크',name_en:'Hold-Scarred Orc',ancestry:'orc',summary:'의례적 흉터나 문신에 참여하는 오크 공동체의 일원입니다. 혈통에서 10 대신 <strong>12 HP</strong>를 얻습니다. <strong>불굴(Diehard)</strong> 재주도 얻습니다.'},
...
const TRAIT_DB = {
  ...
  '죽음':'Necromancy 마법 계열.',
  // 주문 특성
  '집중':'집중 포인트를 소비하여 시전하는 주문.',
  '캔트립':'주문 슬롯 없이 자유롭게 시전. 랭크 = ⌈레벨/2⌉.',
  '지속':'시전자가 매 턴 지속(Sustained) 행동으로 유지해야 함.',
  '의식':'전투 중 시전 불가. 특수 소재 필요.',
  '공포':'감정 효과. 공포 상태를 유발하거나 관련됨.',
  '감정':'감정 기반 효과. 감정 면역 생물에게 효과 없음.',
  ...
  '식물':'Plant 생물 분류.',
  // 주문 특성 (누락분)
  '조작':'조작(Manipulate) 행동. 손을 사용하여 무언가를 조작합니다.',
  '공격':'공격(Attack) 특성. 다중 공격 페널티가 적용됩니다.',
  '활력':'활력(Vitality) 에너지. 산 것을 치유하고 언데드에 피해.',
  '공허':'공허(Void) 에너지. 산 것에 피해, 언데드를 치유.',
  '변이':'변이(Morph) 효과. 신체를 변형시킵니다.',
  '탐지':'탐지(Detection) 효과. 무언가의 존재를 감지.',
  '투시':'투시(Scrying) 효과. 원거리에서 대상을 관찰.',
  '순간이동':'순간이동(Teleportation). 공간을 이동.',
  '주문형성':'주문형성(Spellshape). 다음 시전할 주문의 형태를 변경.',
  '작곡':'작곡(Composition) 합주 주문. 바드 전용.',
  '무력화':'무력화(Incapacitation). 대상 레벨이 주문 랭크×2 이상이면 성공도 한 단계 상승.',
  ...
  '물':'물(Water) 원소 효과.',
  '그림자':'그림자(Shadow) 효과.',
  '언어':'언어(Linguistic) 효과. 대상이 언어를 이해해야 함.',
  '청각':'청각(Auditory) 효과. 대상이 들을 수 있어야 함.',
  '시각':'시각(Visual) 효과. 대상이 볼 수 있어야 함.',
  '환영':'환영(Illusion) 효과. 감각을 속입니다.',
  '불운':'불운(Misfortune). 판정을 두 번 굴리고 낮은 결과 사용.',
  '행운':'행운(Fortune). 판정을 두 번 굴리고 높은 결과 사용.',
  '힘':'힘(Force) 에너지.',
  // 재주 분류/특수 특성
  '일반':'클래스 무관 선택 가능한 재주.',
  '기술':'해당 기술 훈련됨이 선행 조건인 재주.',
  '원형':'다중 클래스 전용 재주.',
  '일반 기술':'일반 기술 재주.',
  ...
  '이동':'이동을 포함하는 행동.',
  '자세':'자세(Stance). 한 번에 하나의 자세만 유지 가능.',
  '압박':'압박(Press). 다중 공격 페널티가 적용된 후에만 사용 가능.',
  '화려함':'턴당 1회만 사용 가능.',
  '봉헌':'봉헌(Consecration) 효과. 신성 의식.',
  '탐험':'탐험(Exploration) 활동. 전투 밖에서 사용.',
  '정밀':'정밀(Precision) 피해. 같은 대상에 1라운드 1회만.',
  '예측':'예측(Fortune/Misfortune) 효과.',
  // 클래스 특성
  '바드':'바드(Bard) 클래스 재주.',
  '클레릭':'클레릭(Cleric) 클래스 재주.',
  '드루이드':'드루이드(Druid) 클래스 재주.',
  '파이터':'파이터(Fighter) 클래스 재주.',
  '레인저':'레인저(Ranger) 클래스 재주.',
  '로그':'로그(Rogue) 클래스 재주.',
  '위치':'위치(Witch) 클래스 재주.',
  '위자드':'위자드(Wizard) 클래스 재주.',
  // 혈통 특성 보강
  '체인질링':'체인질링(Changeling). 해그의 후손.',
  '네피림':'네피림(Nephilim). 차원 혈손.',
  '아이우바린':'아이우바린(Aiuvarin). 반엘프.',
  '드로마르':'드로마르(Dromaar). 반오크.',
};
...
const SKILLS = [
  ...
  {id:'arcana',      name:'신비학', en:'Arcana',       attr:'int'},
...
const SKILL_NAME_MAP = {
  '곡예':'acrobatics','신비학':'arcana','운동':'athletics','제작':'crafting',
...
const ACTION_DB = [
  ...
  // ── 운동 (Athletics) 기술 행동 ──
  {id:'climb',         cat:'skill', cat_label:'운동 행동', name_ko:'등반',            name_en:'Climb',          cost:'1',        traits:['이동'],            req_skill:'athletics', req_rank:0, req_feat:null, summary:'<strong>특성:</strong> 이동<br><br>수직 표면을 오릅니다. 등반 성공 시 5피트 위로 이동(대성공 시 10피트, 실패 시 이동 안 됨, 대실패 시 추락). 등반 중에는 <strong>방심</strong>입니다. DC는 표면에 따라 다릅니다.'},
  ...
  {id:'shove',         cat:'skill', cat_label:'운동 행동', name_ko:'밀기',            name_en:'Shove',          cost:'1',        traits:['공격'],            req_skill:'athletics', req_rank:0, req_feat:null, summary:'<strong>특성:</strong> 공격<br>적을 뒤로 밉니다. 운동 판정을 적의 인내 DC에 대해 시도합니다. 대성공: 5피트 밀고 따라감 가능, 성공: 5피트 밀기, 실패: 효과 없음, 대실패: 방심.'},
  {id:'trip',          cat:'skill', cat_label:'운동 행동', name_ko:'넘어뜨리기',      name_en:'Trip',           cost:'1',        traits:['공격'],            req_skill:'athletics', req_rank:0, req_feat:null, summary:'<strong>특성:</strong> 공격<br>적을 엎드리게 합니다. 운동 판정을 적의 반사 DC에 대해 시도합니다. 대성공: 대상이 엎드리고 1d6 둔기 피해, 성공: 엎드림, 실패: 효과 없음, 대실패: 당신이 방심.'},
  {id:'grapple',       cat:'skill', cat_label:'운동 행동', name_ko:'붙잡기',          name_en:'Grapple',        cost:'1',        traits:['공격'],            req_skill:'athletics', req_rank:0, req_feat:null, summary:'<strong>특성:</strong> 공격<br>빈 손으로 적을 붙잡으려 합니다. 운동 판정을 적의 인내 DC에 대해 시도합니다. 대성공: 속박(restrained), 성공: 붙잡힘(grabbed), 실패: 효과 없음, 대실패: 적이 당신을 붙잡거나 당신이 방심.'},
  {id:'disarm',        cat:'skill', cat_label:'운동 행동', name_ko:'무장해제',        name_en:'Disarm',         cost:'1',        traits:['공격','교묘'],     req_skill:'athletics', req_rank:2, req_feat:null, summary:'<strong>특성:</strong> 공격<br>적의 무기나 물건을 빼앗으려 합니다. 운동 판정을 적의 반사 DC에 대해 시도합니다. 대성공: 물건이 땅에 떨어짐, 성공: 대상이 -2 상황 페널티(공격과 조작), 실패: 효과 없음, 대실패: 방심.'},
  ...
  {id:'reposition',    cat:'skill', cat_label:'운동 행동', name_ko:'위치 변경',       name_en:'Reposition',     cost:'1',        traits:['공격'],            req_skill:'athletics', req_rank:0, req_feat:null, summary:'<strong>특성:</strong> 공격<br>적을 원하는 위치로 강제 이동시킵니다. 운동 판정을 적의 인내 DC에 대해 시도합니다. 대성공: 5피트 이동시키고 당신도 따라감, 성공: 5피트 이동, 실패: 효과 없음, 대실패: 방심.'},

  // ── 곡예 (Acrobatics) 기술 행동 ──
  {id:'balance',       cat:'skill', cat_label:'곡예 행동', name_ko:'균형 잡기',       name_en:'Balance',        cost:'1',        traits:['이동'],            req_skill:'acrobatics', req_rank:0, req_feat:null, summary:'<strong>특성:</strong> 이동<br><br>좁거나 불안정한 표면 위를 이동합니다. 곡예 판정을 시도합니다. DC는 표면에 따라 달라집니다. 균형 잡기를 시도하는 동안 당신은 <strong>방심(off-guard)</strong>입니다.<br><strong>대성공:</strong> 이동 속도까지 이동하며 지형을 험지로 취급합니다(일반적으로 절반 속도).<br>'},
  ...
  {id:'feint',         cat:'skill', cat_label:'기만 행동', name_ko:'페인트',          name_en:'Feint',          cost:'1',        traits:[],                  req_skill:'deception', req_rank:2, req_feat:null, summary:'<strong>특성:</strong> 정신<br><br>기만적인 동작으로 적을 진짜 공격에 대비시키지 못하게 합니다. 기만 판정을 대상의 감지 DC에 대해 시도합니다.<br><strong>대성공:</strong> 대상이 다음 턴 종료까지 당신의 근접 공격에 방심.<br>'},
  ...
  {id:'sneak-attack-ability',cat:'feat',cat_label:'재주 행동',name_ko:'기습 공격',    name_en:'Sneak Attack',   cost:'passive',  traits:[],                  req_skill:null, req_rank:0, req_feat:'기습 공격', summary:'방심(off-guard) 상태인 생물에 민첩/기교 근접 무기, 민첩/기교 비무장 공격, 원거리 무기/비무장 공격으로 타격 시 <strong>추가 1d6 정밀 피해</strong>. 투척 근접 무기는 민첩/기교여야 합니다. 5, 11, 17레벨에 피해 주사위가 1개씩 증가.'},
