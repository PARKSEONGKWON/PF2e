...
const HERITAGE_DB = [
  ...
  // 엘프
  {id:'ancient-elf',name_ko:'고대 엘프',name_en:'Ancient Elf',ancestry:'elf',summary:'긴 삶에서 많은 길과 많은 양식을 섭렵했습니다. 전형적인 고대 엘프는 최소 100세이지만, GM 재량으로 더 젊을 수 있습니다. 자신의 것이 아닌 다른 클래스의 멀티클래스 헌신 특기를 얻습니다. 멀티클래스 헌신 재주의 레벨 전제조건(보통 2레벨)을 충족하지 않아도 되지만, 다른 전제조건(능력치 등)은 여전히 충족해야 합니다.'},
  ...
  {id:'cavern-elf',name_ko:'동굴 엘프',name_en:'Cavern Elf',ancestry:'elf',vision:'암시야',summary:'지하 터널이나 동굴에서 태어났거나 오랜 세월을 보냈으며, 빛이 부족한 곳입니다. 암시야(darkvision)를 얻습니다.'},
  ...
  {id:'sensate-gnome',name_ko:'감각 노움',name_en:'Sensate Gnome',ancestry:'gnome',summary:'모든 색을 더 밝게, 모든 소리를 더 풍부하게, 특히 모든 냄새를 놀라운 세부 사항으로 느낍니다. 특수 감각을 얻습니다: 30피트 범위의 부정확 후각(imprecise scent). 이것은 후각으로 생물의 대략적 위치를 감지할 수 있다는 의미입니다(정확한 위치는 알 수 없음). GM은 일반적으로 바람이 생물로부터 불어오면 범위를 두 배로, 생물로 불어가면 절반으로 합니다. 추가로, 후각 범위 내에서 미탐지(undetected) 생물을 찾으려 할 때 감지 판정에 +2 상황 보너스를 얻습니다.'},
  {id:'umbral-gnome',name_ko:'암영 노움',name_en:'Umbral Gnome',ancestry:'gnome',vision:'암시야',summary:'어둡거나 그림자의 페이와의 연결이든, 드라트넬라르(drathnelar)로 알려진 지하 노움이든, 다른 원천이든, 완전한 어둠에서도 볼 수 있습니다. 암시야(darkvision)를 얻습니다.'},
  ...
  // 레쉬
  {id:'fungus-leshy',name_ko:'균류 레쉬',name_en:'Fungus Leshy',ancestry:'leshy',vision:'암시야',summary:'동굴과 나무 그늘에서 자라는 균류로 만들어졌으며, 어둠 동굴과 터널이 편합니다. 암시야(darkvision)를 얻습니다. 식물 특성을 잃고 균류(fungus) 특성을 얻습니다.'},
...
const TRAIT_DB = {
  ...
  '쓸기':'쓸기(Sweep). 다중 대상 공격 시 이전 대상에 명중했으면 후속 공격에 +1 상황 보너스.',
  '강제 개방':'강제 개방(Forceful). 2번째 공격 피해 주사위 1개 추가, 3번째 이후 2개 추가.',
  '넘어뜨리기':'넘어뜨리기(Trip). 이 무기로 넘어뜨리기 특수 공격을 시도할 수 있음.',
  '해제':'해제(Disarm). 이 무기로 무장해제 특수 공격을 시도할 수 있음.',
  '추진':'추진(Propulsive). 피해에 근력 수정치의 절반을 추가 (양수일 때).',
  '치사 d10':'치사(Fatal d10). 치명타 시 피해 주사위를 d10으로 바꾸고 1d10을 추가.',
  '치사 d12':'치사(Fatal d12). 치명타 시 피해 주사위를 d12로 바꾸고 1d12을 추가.',
  '살포 30ft':'살포(Volley 30ft). 30피트 이내 대상 공격 시 -2 페널티.',
  '수도승':'수도승(Monk). 수도승 재주의 일부가 이 무기에 적용됨.',
  '조이기':'조이기(Grapple). 이 무기로 붙잡기 특수 공격을 시도할 수 있음.',
