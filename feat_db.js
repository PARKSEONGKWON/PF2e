...
,
  {name_ko:"치유의 찬송", name_en:"Hymn of Healing", feat_level:1, prerequisites:"", traits:["바드"], category:"bard", summary:"치유의 찬송 합주 주문을 습득합니다.", desc:'<span class="spell-tip" data-tip="치유의 찬송 [1행동] 합주 캔트립 — 사거리 30피트, 대상: 아군 1 또는 자신, 지속: 유지. 첫 라운드에 1d4 HP 회복. 유지할 때마다 다시 1d4 HP 회복. 강화: 3랭크 2d4, 5랭크 3d4, 7랭크 4d4, 9랭크 5d4."><em>치유의 찬송(Hymn of Healing)</em></span> 합주 주문을 습득합니다. 풍부한 선율로 아군이 피해에서 회복하도록 돕습니다.' }
,
