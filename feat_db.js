...
,
  {name_ko:"치유의 찬송", name_en:"Hymn of Healing", feat_level:1, prerequisites:"", traits:["바드"], category:"bard", summary:"치유의 찬송 합주 주문을 습득합니다.", desc:'<em>치유의 찬송(Hymn of Healing)</em> 합주 주문을 습득합니다. 풍부한 선율로 아군이 피해에서 회복하도록 돕습니다.<br><strong>치유의 찬송</strong>(Hymn of Healing) [1행동] — 합주 캔트립<br><strong>특성:</strong> 바드, 캔트립, 작곡, 집중, 조작<br><strong>사거리:</strong> 30피트 | <strong>대상:</strong> 아군 1 또는 자신 | <strong>지속 시간:</strong> 유지<br>첫 라운드에 대상이 <strong>1d4 HP</strong>를 회복합니다. 유지할 때마다 다시 1d4 HP 회복.<br><strong>강화(3랭크):</strong> 2d4 | <strong>(5랭크):</strong> 3d4 | <strong>(7랭크):</strong> 4d4 | <strong>(9랭크):</strong> 5d4.' }
,
